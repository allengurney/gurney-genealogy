# G32 — FamilySearch Intake Assessment (Gerard de Gournay, LBGV-H99)

**Source artifact**: `sources/FS/20260506FamilyLBGV-H99.pdf` (22 pp., printed 6 May 2026)
**Companion artifacts**: shared with G33 — `sources/FS/MZ68-VKD/racineshistoire_free_fr_LGN_PDF_Gournay.pdf` (Pattou). The Pattou pedigree pp. 2–3 cover Gerard directly.
**Subject FS PID**: LBGV-H99
**Repo target**: G32 (`research/people/g32-gerard-de-gournay-fact-sheet.research.md`, `fact-sheets/g32-gerard-de-gournay-fact-sheet.md`)
...
22-page Family Group Record. Three layers as expected:
- **Structured FGR** (pp. 1–2): husband Gérard de Gournay-en-Bray (LBGV-H99), wife Edith de Warenne (L8BS-QXY), 3 children listed (Walter de Gournay PMP1-5RR, Gundred de Gournay LYLM-Z3D, Seigneur Hugh IV de Gournay en Brie KDM4-ZV2).
- **Sources** (pp. 3–17): the dominant scholarly traditions are FMG MedLands (Cawley) for the Latin charter substrate, Douglas Richardson's *Royal Ancestry* via the TNG site `our-royal-titled-noble-and-commoner-ancestors.com`, and Pattou Racines Histoire (companion PDF). Note the heavy presence of charter references `[875]`–`[907]` from MedLands preserved verbatim on pp. 5–7.
- **Notes** (pp. 7–8, 13–17, 20–21): heavy contributor pasting — including a 2002 Douglas Richardson SGM (soc.genealogy.medieval) post repeated multiple times, plus Kraentzler / Sorley / Brown-book / "United Ancestries" boilerplate.

**Layer peculiarity**: this export contains a substantively **different person profile** in the Notes section under "Person note" / "Seigneur Hugh IV de Gournay en Brie" (pp. 17–21) — covering Hugh IV (Gerard's son and heir to the senior baronial line), with Richardson's full pedigree summary. That is real content for the G32 fact sheet's "Children" table and the senior-baron-line collateral context, *not* for Gerard himself.
...
- Gerard born c. 1043 (FS "about 1043"; repo c. 1040).
- Wife Edith de Warenne, daughter of William de Warenne 1st Earl of Surrey + Gundred.
- Edith's second husband Drew/Drogo/Dreux de Monchy/Monceaux (Mouchy III in the FS structured field's "Other spouses").
- Gerard d. after 1104 in Holy Land, on pilgrimage.
- First-Crusade participation (1096+); died before the capture of Jerusalem.
- Two senior-line children with Edith confirmed by FMG: Hugues IV (1098/1100–1180) and Gundred (1100/1105–after 1155, m. Nigel d'Aubigny Jun 1118).
- 1082 charter to la Trinité de Caen witnessed by both Gerard and his brother William de Gornai.
- Henry II 1181/89 charter to Bec confirms donations by Hugh III, Gerard fils, and Basilia matris.

### 2.2 Net-new content worth promoting

Reproducing FMG transcripts verbatim with reference numbers:

1. **The undated Jumièges charter on Radulphus Havoth's entry as a monk** — independent confirmation of the family group (Hugh III / Gerard / Basilia) beyond the misdated [1040] charter.
   > "Domino meo Hugone Gurnaiensi et filio eius Girardo et uxore eius Basilia" consented to a donation to Jumièges abbey by "Radulphus cognomina Havoth cum uxore mea" on his entering the abbey as a monk, by undated charter[876].

   Citation: Gurney (1845), p. 57, quoting "an old copy in a paper Cartulary of Jumieges", Rouen Archives. **Destination**: G32 research companion, charter-witness section.

2. **[1089/90] Orderic Vitalis: Gerard delivers Gournay, La Ferté-en-Brai, Gaillefontaine to William II Rufus** (the political moment that aligned the Gournays with Rufus against Robert Curthose).
   ...
   Citation: Orderic Vitalis (Prévost), Vol. III, Liber VIII, IX, p. 319. **Destination**: G32 fact-sheet narrative — strengthens the existing "secured his castles for William Rufus" highlight; adds three named places.

3. **[1089] Orderic Vitalis: Gerard's retention of Écouché** — explicitly identifies Gerard as son of Basilia daughter of Gerard Flaitel.
   > "Scoceium" which was held by "Girardus de Gornaco...qui de eadem parentela prodierat, filius...Basiliæ Girardi Fleitelli filiæ", dated to [1089][880].

   Citation: Orderic Vitalis (Prévost), Vol. III, Liber VIII, X, p. 321. **Destination**: G32 research companion (resolves the Écouché / Pont-Saint-Pierre political-settlement detail) and the G33 Basilia file.

4. **Crusade attestations from two independent crusade chronicles**:
   > Albert of Aix names "…Gerardus de Gorna…" among those who took part in the siege of Nikaia, dated to mid-1097 from the context[882]. Baudry names "Girardus de Gornaio" among those on the First Crusade in 1097[883]. Guillaume of Jumièges records that "Giraldus" left for Jerusalem but died while away[884].

   Citations: Albert of Aix (RHC), Liber II, Cap. XXIII, p. 316; Baudry (RHC) II.I, p. 33; Willelmi Gemmetencis Historiæ (Duchesne, 1619), Liber VIII, VIII, p. 296. **Destination**: G32 research companion — these are exactly the named-source crusade attestations the existing companion's "Death date discrepancy" working note (line 23) wished it had. Domesday Descendants p. 492 [881] is the FMG cite for "He and his wife participated in the First Crusade but he died before the capture of Jerusalem."

5. **Edith de Warenne's first-Crusade companionship** — Guillaume of Jumièges explicitly names her as on the journey with Gerard:
   > Guillaume of Jumièges records that "Giraldus" left for Jerusalem "cum uxore sua Edithua sorore Willelmi comitis de Warenna", who married secondly "Drogoni de Monceio", by whom she had "unum filium...Drogonem"[886].

   Citation: Willelmi Gemmetencis Historiæ (Duchesne, 1619), Liber VIII, VIII, p. 296. **Destination**: G32 fact-sheet narrative — confirms that Edith accompanied Gerard on the crusade (the existing fact-sheet narrative says "set out again for the Holy Land with his wife Edith" without primary citation).

6. **Edith was *sister* of William II de Warenne**, not just daughter of William I — minor but useful: Guillaume de Jumièges identifies her as "sorore Willelmi comitis de Warenna" (i.e., sister of the *count*, who is the son who succeeded). This places Edith socially in the second generation of the Warenne earldom.

7. **Amicie de Gournay / Talbot parentage problem (FMG's three hypotheses)** — fully transcribed in the export pp. 5–6, 14:
   > Orderic Vitalis records that "Hugo filius Girardi de Gornaco" rebelled against King Henry I after the marriage of his sister Gundred in Jun [1118], and captured "municipium...Plessicii" which he granted to "nepoti eius Hugoni Talabot"[888].

   FMG's three options for Amicie's parentage:
   - daughter of Gerard by Edith de Warenne (chronologically tight);
   - daughter of Gerard by an earlier unrecorded marriage (FMG's preferred reading on balance);
   - daughter of Hugues [III] de Gournay (more remote *nepos* sense).

   Two Henry-II-era charters confirm her name and family:
   > Henry II King of England confirmed the possessions of the abbey of Valmont, including donations by "…Richardi Tallebot et Amicie uxoris eius et Hugonis et Willelmi filiorum suorum…", by charter dated to [1181/83][889]. Henry II King of England confirmed the possessions of the priory of Sainte-Foi de Longueville, including donations by "Ricardi Thalebot et Avitie uxoris sue et Hugonis filii sui", by charter dated to [Mar/Jun] 1189[890].

   **Destination**: a new `research/case-files/amicie-de-gournay-talbot-parentage.md`. Already flagged in the G33 assessment.

8. **Pattou (companion PDF) gives Gerard birth ~1073**, repo c. 1040, FMG silent. Pattou's 1073 is internally consistent with Edith de Warenne (b. 1072–1080) marriage 1084–1092 — Gerard would be ~17 at lower-bound marriage. Repo's c. 1040 makes Gerard ~45 at marriage to a teenage bride. **Pattou's 1073 actually fits the chronology better than the repo's c. 1040.** Worth flagging as a substantive scholarly disagreement, not just a date drift.
   > "Girard de Gournay ° ~ 1073 + après 1104 (Palestine ou Nicée en Asie Mineure ?) seigneur de Gournay, soutient Raoul de Tosny avec Etienne d'Aumale contre Guillaume d'Evreux, croisé (1096) ép. 1) ? (possible mère d'Amicie, épouse de Richard Talbot) ép. 2?) entre 1084 & 1092 Edith (Edive) de Warenne ° entre 1072 & 1080" (Pattou p. 3)

   But: a Gerard born 1073 cannot have witnessed the 1082 Trinité de Caen charter at age 9, which the export and FMG both show him doing alongside William de Gornai. So Pattou's 1073 is also problematic. The c. 1040–1050 range may be the safer reconciliation; the 1082 charter signature is the chronological lower bound.

9. **French Wikipedia (fetched live)** confirms the Norfolk-junior-line connection thread:
   ...
   And explicitly attributes Sigy (Sigy-en-Bray, the Norman foundation that became the Lessingham parent house) to Hugh III, founded c. 1037–1045 and made subject to St-Ouen de Rouen — reinforcing the existing G33 1076 Bec charter narrative.

10. **WikiTree Warenne-78 (fetched live)** states Edith's second marriage to "Dreux/Drew/Drogo de Moncy" was in **1107**, with one son Dreux II "the younger" (d. after 1147). Gerard's death "after 1104" plus Edith's remarriage 1107 gives a tighter chronology than the existing fact-sheet's vague "after Gerard's death." (WikiTree should be downgraded if it is contradicted by a primary; Guillaume de Jumièges does not date the second marriage. Treat as approximate.)

### 2.3 FS conflicts with repo (FS likely wrong)

| Item | FS export | Repo | FS sourced? | Disposition |
|---|---|---|---|---|
| Gerard's father d. date | Hugh III "d. 1110" (in TNG p. 3 entry "FatherHugh III de Gournay…b. b 1044, d. 1110") | Hugh III d. c. 1093 | Yes — TNG site cites Richardson Royal Ancestry Vol. III pp. 62, 92–93 | Repo correct (FMG: -[1093]). Richardson via TNG appears wrong on Hugh III's death year by ~17 years. |
| Gerard's birthplace | "Gournay-en-Bray, Seine-Maritime, France" (FS structured) and **"of Caistor, by Yarmouth, Norfolk, England"** (Richardson via TNG p. 3) | c. 1040 Gournay-en-Bray (repo); 1082 first appearance at Caen (when Hugh III was still in his prime in Normandy) | Yes for the Caistor claim (Richardson) | Norfolk birthplace is implausible — Caister-by-Yarmouth came into the family via Edith de Warenne *after* Gerard's marriage [1084/92]. Gerard cannot have been born at his future wife's father's manor. **TNG entry is internally inconsistent.** Repo correct on Gournay-en-Bray. |
| Edith's death | "1178" (FS structured) and "Lewes, Sussex" deathplace; "Burial about 1160 Jerusalem, Jerusalem Mutasarrifate, Ottoman Empire" (FS structured) | "after 1155" per FMG | No — FS date 1178 is unsupported in the embedded sources; "Jerusalem burial" is a structured-field artifact tied to the Crusade narrative | FS wrong. FMG's "after 1155" is the conservative range. The Jerusalem burial is an FS-tree confabulation. |
| Edith's birthplace | "Sussex, England" (FS structured); WikiTree "Oxfordshire, England" | FMG: not specified | No solid source in FS for either place | Insufficient evidence; do not adopt a specific birthplace. FMG: "[1072/80]". |
| Edith's father | "William de Warenne I (LDSS-ZCS)" | William de Warenne 1st Earl of Surrey | Yes | Concordant. |
| Edith's mother | "Countess Gundred de St Omer Of Flanders (LBDX-4LG)" | Gundred sister of Gerbod the Fleming | Yes (FS structured) | Repo phrasing "sister of Gerbod the Fleming" is the cautious FMG version; "de St Omer Of Flanders" is one community-tree extrapolation of the family origin (Gerbod was Earl of Chester from St Omer in Flanders). Hold both. **Note**: the long-disputed claim that Gundred was a daughter of William the Conqueror is not asserted in this export (the modern FS tree appears to have settled the Gerbod-the-Fleming sibling identification). |
| Children list (3 children) | Walter (PMP1-5RR), Gundred (LYLM-Z3D), Hugh IV (KDM4-ZV2) | Repo has Hugh IV, Walter (G31), Gundred, plus eldest-son Gerard (d. *vit. pat.*) | FS structured | FS omits the eldest-son Gerard who died vit. pat. — DG's pedigree p. 277 is the only source for him. The FS list of 3 confirmed children is otherwise concordant with DG/Richardson. |
| Walter's birthplace | "1096 Gournay, Norfolk, England" (FS) | repo: Walter fl. 1108–1154, Suffolk | Yes (FS) | Norfolk is wrong; Walter's documented holdings are Suffolk (Liber Niger Scaccarii i. 298). And "Gournay, Norfolk" doesn't exist — there's no English place named Gournay in Norfolk. Likely community-tree error conflating Caister-by-Yarmouth with the Norman seat. |
| Walter's spouse | "Mrs. Walter De Gournay (9S9P-SG5)" | repo: not specified | No (FS placeholder) | FS placeholder PID for unnamed wife. No content. |
| Gundred's birthplace / death | "1097 Aubigny, Normandy, France" / "1155 York, Yorkshire, England" / Burial Byland Abbey | repo / FMG: ~1100/1105–after 1155 | Mixed | Birthplace "Aubigny" looks like a confusion with husband's family seat (d'Aubigny / Albini). FindAGrave 161656935 (cited p. 16) gives "Birth 1097 Gournay-en-Bray" — at least geographically plausible. Death/burial at Byland Abbey (Yorkshire) is consistent with her patronage of Byland and Rievaulx. |
| Gundred's marriage date and children | June 1118 / one son Roger de Mowbray; "Robert d'Aubigny" b. c 1115 (TNG p. 15) | FMG / repo: m. Jun 1118; sons Roger de Mowbray and Henry (ancestor of Albini of Cainho per Planché p. 16); Roger b. after 1109 | Yes (Richardson via TNG cites Magna Charta Sureties + Royal Ancestry III p. 62 + GeneaNet [S59]) | TNG list omits Henry / second son; Planché entry on p. 16 is the better source. The "Robert d'Aubigny" b. 1115 is suspicious — possibly a TNG-side conflation. |
| Hugh IV birth | "about 1107" (FS structured) | "[1098/1100]" (FMG) and "born about 1091 (of full age in 1112)" (Richardson SGM 2002 post embedded p. 19, repeated p. 20) | Mixed | The Richardson 2002 SGM post says **"born about 1091 (of full age in 1112)"** which is earlier than FMG's [1098/1100]. Resolution: DG and Richardson use 1091 (working back from "of full age in 1112"); FMG accepts a slightly later range. Both positions to record. |
| Hugh IV's first wife | "Béatrice de Vermandois (LB3C-NWX), 1082–1130" (FS) | Richardson SGM 2002 p. 20: "BEATRICE DE VERMANDOIS, daughter of Hugh le Grand, Count of Vermandois and Valois, Count of Amiens and Crepy, by Alix, daughter and heiress of Herbert IV, Count of Vermandois and Valois" | Yes — Richardson | Concordant. *Beatrice* (Pattou says "Béatrix de Vermandois ° ~1082 + après 1144"); Richardson dates her death later. |
| Hugh IV's second wife | "Melisende de Coucy (LY62-B1T)" (FS), "Mélisende de Marle-Coucy ° ~1120 + 1181" (Pattou), "MILLICENT (or MELISENDE) DE COUCY, widow of Aleaume Fitz Adam, Governor of the Citadel of Amiens, daughter of Thomas de Coucy (or de Marle)" (Richardson) | concordant | Yes | Concordant across sources. Date of marriage Pattou says "après 1151"; Richardson says they founded the Abbey of Gaillefontaine 1144/64. |

### 2.4 Spurious / over-claimed structured-field content

The FS structured table is unusually clean for this export — only three children listed, all corroborated. The main spurious claims are:

- **Walter de Gournay's "Gournay, Norfolk" birthplace** (no such place exists).
- **Gundred's "Aubigny, Normandy" birthplace** (likely confusion with Nigel d'Aubigny's family seat, not where she was born).
- **Edith's "Burial Jerusalem 1160"** (a structured-field confabulation; FMG says she returned and remarried).
- **The dispute embedded in the "Notes and sources from Life sketch" section (pp. 7, 13)** — this is a long Douglas Richardson note arguing **DG was wrong to make Walter de Gournay (G31) the son of Gerard**:
  > "[author alleges that Gerard de Gournay and his wife, Ediva, had a younger son, Walter de Gournay (living 1150), ancestor of the Gurnay family of Norfolk. Such an individual existed but he had no association in the records with the senior branch of the Gournay family. Rather, it appears that Walter was closely related to a Galiena de Gournay, born say 1120, living c. 1170, wife of Manasser de Dammartin (died 1178/9)…Charter evidence proves that Galiena was the granddaughter of an unplaced William de Gumay, of Addington, Kent…Given these facts, it is doubtful that Walter de Gournay was the son of Gerard de Gournay as alleged…"

  Cited authorities: Hasted 4 (1798): 544–545; Copinger Manors of Suffolk 3 (1909): 277–278; Loyd & Stenton, *Sir Christopher Hatton's Book of Seals* (1958): 229–230, 239–240; *VCH Essex* 4 (1956): 151–152; *Genealogist* 15 (1965): 53–63 (Dammartin family article); Jenkins *Cartulary of Missenden Abbey* 1: 70–75; Gervers *Cartulary of the Knights of St. John of Jerusalem in England: Secunda Camera/ Essex* 1 (1982): 216; Power *Norman Frontier in the 12th & Early 13th Cents.* (2004): 355–357; Tanner *Fams., Friends, & Allies* (2004): 315 (Warenne ped.).

  This is **the live junction point** in the repo's claim that the Gurney direct line descends through Walter (G31). DG's identification is the spine of the repo's chain G31 → G32 → G33. Richardson rejects it. The existing G32 research companion (line 99, "Pettigrew on Gerard, Edith de Warenne, and the younger-son branch") notes Pettigrew flagging "DG thought Walter de Gournai was another [son]." DG-Supp Note 104 (G32 companion line 39) gives DG's generational rebuttal. **This is the single highest-stakes finding in the entire batch.** Worth a dedicated case file: `research/case-files/walter-de-gournay-as-son-of-gerard.md`, with side-by-side DG / Pettigrew / Richardson / Galiena-de-Gournay-via-Manasser-de-Dammartin lines of argument.

- **The Pattou "junior line" chart (pp. 5–11)** independently and explicitly says Walter is **"possible petit-fils de Girard de Gournay et d'Edive de Warenne"** — i.e., possibly *grand*son, not son. This sides with neither DG nor Richardson cleanly: it accepts a Gournay-line connection but downgrades it from son to grandson.

---

## 3. FS Tree update suggestions

| FS field (PID LBGV-H99 unless noted) | Current FS value | Suggested correction | Repo / scholarly citation |
|---|---|---|---|
| Death place | "Caistor, Norfolk" | "Holy Land / Palestine" | Richardson via TNG p. 3: "Died after 1104 at Holy Land; Died while on pilgrimage." Embedded text on p. 3 already says "after 1104 at Holy Land" — the FS structured Death-place field should be updated to match the embedded source. |
| Burial place | "after 1104 Jerusalem, Jerusalem Mutasarrifate, Ottoman Empire" | Remove or set to "Holy Land — burial place unknown" | Anachronistic ("Ottoman Empire" did not exist in 1104); Guillaume de Jumièges only says "died while away" without specifying burial. |
| Birthplace | "Gournay-en-Bray, Seine-Maritime, France" | Keep | Concordant with embedded sources; the TNG "of Caistor by Yarmouth Norfolk" claim should be discounted (chronologically impossible — see §2.3). |
| Marriage date | "1091" | "[1084/92]" range | FMG explicitly. |
| Marriage place | "Gournay-en-Bray, Seine Maritime, Duché de Normandie" | Remove or set to "France (place unspecified)" | No source specifies marriage place. Edith was a Sussex/Norfolk Warenne; could equally have married in England or Normandy. |
| Wife's death | "1178 Lewes, Sussex, England" | "after 1155, place unknown" | FMG. The 1178 date is unsupported. |
| Wife's burial | "about 1160 Jerusalem" | Remove | Confabulation. |
| Child #1 Walter birthplace | "1096 Gournay, Norfolk, England" | Remove birthplace (and consider re-evaluating the entire parent-child link given Richardson's rejection of DG's Walter-as-son claim) | "Gournay, Norfolk" is not a real place. |
| Child #2 Gundred birthplace | "1097 Aubigny, Normandy, France" | "[1100/1105], place unknown" | FMG. "Aubigny" is the husband's family seat. |

For sourced FS entries that conflict with repo (mainly Richardson positions hitting differently from FMG):

| FS field | FS-cited source | Repo source | Recommended action |
|---|---|---|---|
| Hugh III d. 1110 | Richardson Royal Ancestry III p. 92–93 (via TNG p. 3) | FMG: -[1093]; DG: c. 1093 | Hold open in research as a Richardson-vs-FMG-vs-DG numbering discrepancy. The 1110 date is a substantial outlier worth a footnote at G33. |
| Hugh IV b. about 1091 / of full age 1112 | Richardson SGM post 11 Sep 2002 (in FS p. 19, p. 20) | FMG: [1098/1100] | Hold both. |
...
|---|---|---|
| https://our-royal-titled-noble-and-commoner-ancestors.com/p197.htm | fetched | Confirms Richardson's Royal Ancestry III pp. 62, 92–93 lineage. Asserts Hugh III's death "1110" (conflicts with FMG/DG). Birthplace "Caistor by Yarmouth, Norfolk" for Gerard (chronologically impossible). |
| https://our-royal-titled-noble-and-commoner-ancestors.com/p182.htm | not fetched (already heavily quoted in the FS PDF p. 12–13) | Edith de Warenne; Magna Charta Sureties citation. |
| https://en.wikipedia.org/wiki/William_de_Warenne,_1st_Earl_of_Surrey | fetched (via G33 pass) | Confirms Edith's marriages; modern Wikipedia silent on Conqueror-descent for Gundred. |
| https://www.wikitree.com/wiki/Warenne-78 | fetched | Edith's second marriage to Drew de Moncy in 1107; one son Dreux II "the younger" d. after 1147. Adds FMG/DG-independent dating. |
| https://fr.wikipedia.org/wiki/Famille_de_Gournay | fetched (via G33 pass) | Caveat: numbering of Hugues "peut-être erronée"; Delisle critique of DG explicitly noted. |
| http://racineshistoire.free.fr/LGN/PDF/Gournay.pdf | fetched (companion PDF) | Pattou pp. 2–3 give Gerard's chart entry ° ~1073, two marriages, supports Raoul de Tosny / Etienne d'Aumale against Guillaume d'Évreux. |
...
| URL | Reason for skip |
|---|---|
| https://fmg.ac/Projects/MedLands/normacre.htm | Substantively embedded in FS pp. 5–7. |
| https://fmg.ac/Projects/MedLands/normacre.htm#_Toc108863566 | Same. |
| https://web.archive.org/web/20240826200046/https://fmg.ac/...AmicieGournayMRichardTalbot | Same — Wayback snapshot of the same FMG page; useful as stable retrieval URL but not as a new source. |
| https://babel.hathitrust.org/cgi/pt?id=yale.39002006511357&view=1up&seq=93&q1=Hugues+IIi+de+Gournay | Daniel Gurney 1848 — already in repo source canon. |
| https://www.history.com/this-day-in-history/jerusalem-captured-in-first-crusade | Generic 1099 First Crusade summary — no Gournay-specific content. |
...
1. Add the **Albert of Aix and Baudry crusade attestations** by name to the G32 research companion's "Death date discrepancy" working note — these are the named-source attestations that resolve the "did the father or the son fight at Nicaea" question (the father fought; the son died vit. pat. — the father survived to return).
2. Add the **Guillaume of Jumièges passage on Edith accompanying Gerard** ("cum uxore sua Edithua") to the fact-sheet narrative as a primary citation for the joint-pilgrimage detail.
3. Add the **Orderic Vitalis [1089/90] passage on Gerard delivering Gournay/La Ferté/Gaillefontaine to William II Rufus** to fact-sheet narrative — strengthens the "secured his castles for William Rufus" highlight with three named places.
4. Add the **Orderic [1089] passage on Écouché** to the research companion as the documented basis for Gerard's continued tenure of his mother Basilia's *maritagium*.
5. Add the **[1181/89] Henry II Bec confirmation charter** as twelfth-century corroboration of donations.
6. **Surface the Walter-de-Gournay-as-son-of-Gerard dispute** as a top-level item: open `research/case-files/walter-de-gournay-as-son-of-gerard.md` collecting the DG (yes, generational proof DG-Supp Note 104), Pettigrew (yes, summary), Richardson (no, with bibliography), Pattou (grandson, not son) positions. **This is the highest-stakes collateral finding in the entire G30–G36 batch** because it touches the integrity of the repo's direct-line chain at the G31/G32 junction.
7. Add the **two Henry-II charters confirming Amicie Talbot** to a new `research/case-files/amicie-de-gournay-talbot-parentage.md`.
8. **Surface Pattou's Gerard b. ~1073** as an additional date hypothesis in a research-tier note, with the chronological argument: 1082 Trinité de Caen charter signature requires Gerard b. before c. 1066 (i.e., closer to repo's c. 1040). Pattou's 1073 should not be adopted but is worth recording.

**Decline / quarantine**:
- Caistor-by-Yarmouth as Gerard's birthplace.
- Edith's 1178 death year and Jerusalem burial.
- Walter's "Gournay, Norfolk, England" birthplace.
- Gundred's "Aubigny, Normandy" birthplace.
- The various Brown-book / Sorley / Kraentzler / "Royal Ancestors PC #549" boilerplate.

**`data/sources.json` bookkeeping**:
- New: `richardson-royal-ancestry-v3` — referenced via TNG site `our-royal-titled-noble-and-commoner-ancestors.com` and via Richardson's 2002 SGM post. Cite as Douglas Richardson, *Royal Ancestry*, vol. III (Richardson Genealogical Services, 2013).
- New: `albert-of-aix-historia-rhc` — Albert of Aix, *Historia Hierosolymitana*, in *Recueil des Historiens des Croisades, Historiens Occidentaux*, Liber II, Cap. XXIII, p. 316.
- New: `baudry-of-dol-rhc` — Baudry of Dol, *Historia Hierosolymitana*, RHC II.I, p. 33.
- New: `guillaume-of-jumieges-historia-duchesne-1619` — Willelmi Gemmetencis Historiæ (Duchesne, 1619), Liber VIII, VIII, p. 296. (Note: the more standard modern critical edition is Marx 1914 / van Houts 1992–95; if the repo prefers a modern edition, use those.)
- New: `actes-henri-ii` — *Recueil des actes de Henri II roi d'Angleterre et duc de Normandie*, Tome II, charters DCXXXVI (Valmont, 1181/83), DCCXLIV (Bec, 1181/89), DCCLXVIII (Sainte-Foi de Longueville, 1189). Delisle & Berger eds.
- New: `pipe-roll-31-henry-i` — Pipe Roll 31 Henry I (1129/30), Leicestershire, p. 87 (Gunderede uxori Nig de Albin).
- Refresh: `pattou-racines-histoire-gournay-2025` (already proposed at G33).

---

## 6. Open items still requiring human judgment

1. **Walter as son of Gerard (G31 → G32 link)**: DG (yes), Pettigrew (yes, summary), Richardson 2002 SGM (no, with extensive bibliography — Hasted, Copinger, Loyd & Stenton, *VCH Essex*, *Genealogist*, Power, Tanner), Pattou (grandson). The repo's direct line depends on this. Resolution requires a dedicated case file.
2. **Gerard's birth year**: c. 1040 (DG / repo), c. 1043 (FS / FMG-implied), ~1073 (Pattou). The 1082 Caen charter signature is the chronological lower bound. c. 1040–1050 is the safest range.
3. **Hugh IV's birth year**: c. 1091 (Richardson, "of full age in 1112") vs. [1098/1100] (FMG). Both have logic; preserve both.
