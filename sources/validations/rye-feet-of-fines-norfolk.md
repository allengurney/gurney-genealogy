# Validation — Rye, *Short Calendar of the Feet of Fines for Norfolk* (Parts I–II)
...
- **g24 John de Gournay IV companion** — entry 489 (Pt II): "John Gurnay, parson of the church of Harpele [Harpley]" — the Rector John (John IV's great-uncle), corroborating his Harpley incumbency.

**Attribution-open early entries — now placed.** Several further Gurnay fines not confidently tied to a single direct ancestor from the calendar text (William fil. Philip de Gurnay and Elena, Pt II entry 146; and Part I early-reign entries — Hugh de Gurnay; William de Gurnay v. Ingaldesthorp, entry 874; John de Gurnay v. Sarra wife of Roger de Cressingham, entry 1059; "Gurney of the manor of Saxthorpe") are now recorded with per-generation hints in the landholding topic file `research/places/england-landholding-catalog-gap-findings-g18-g31.md` ("Rye's Feet of Fines — early Gurnay entries"), pending closer dating against the G24–G31 floruits.
