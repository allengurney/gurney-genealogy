# Media — East Dereham manor court books, Gurney entries (FamilySearch films 004389483 / 004389277)

Full-resolution court-book page images behind the East Dereham copyhold-Gurney analysis (lead L-98) in [`research/people/g13-john-gurney-fact-sheet.research.md`](../../../research/people/g13-john-gurney-fact-sheet.research.md). Paleographic reports: `sources/corpus_supplement/paleo-2026-06-packet-07..09-*.md`.

## `_local/` (not committed — FamilySearch terms restrict redistribution)

| File | Content | Retrieve from |
|---|---|---|
| `dereham-1636-margarete-gurner-wwm.jpg` | Court of 10 Oct 1636 (12 Chas I) — "quondam Margarete Gurner vid[uae]" in Hugh Browne's surrender; film 004389483 image 1632 | [ark:/61903/3:1:S3HY-D1S9-WWM](https://www.familysearch.org/ark:/61903/3:1:S3HY-D1S9-WWM) |
