...
[^marginal-annotations]: Procedure §16.3 in `research/topics/_legacy/east-dereham-ai-assistant-procedure/east-dereham-ai-assistant-procedure.md` already flagged the modern 1610 annotation on the 00721 page as external. The modern "1620" annotation on the 00732 page sits outside the parchment edge in the user's image set; the user has confirmed only the 00732 page carries a modern annotation outside the parchment in this corpus.
[^john-withdrawn]: Norfolk Record Office, East Dereham register bills (PD 86/41), images 00715, 00722 and 00726, re-read across the full image run against recorded coordinates in the deviation audit of 22 July 2026. The audit itemises ten deviations and eight root causes in the March–May 2026 analysis; the misattributed line is the first of them. The superseded four-test letterform analysis is described at `research/topics/_legacy/east-dereham-ai-assistant-procedure/east-dereham-ai-assistant-procedure.md` §10–§14, and the six-state image rebuild at `sources/media/Parish_Register_East_Dereham/page_00715_entry_e_john_six_state_sweep.png`; both are retained as a record of method rather than as evidence. Source ID: `nro-pd-86-41`.
