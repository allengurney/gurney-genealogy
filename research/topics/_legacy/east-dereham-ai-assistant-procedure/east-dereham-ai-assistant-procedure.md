...
status: retired from publication, retained as a record of method
retired: 1 August 2026
originalPermalink: /key-research/east-dereham-ai-assistant-procedure.html
---

> **This page is no longer published.** It documents, step by step, how a March 2026
> analysis read an East Dereham parish-register entry as *"John the sonne of ffrancis
> Gurnie."* **That reading is withdrawn.** The line adjudicated in March 2026 is on image
> `00722` and reads *"Amorye the daughter of Robart Enderby, Ianuarij 10"*; the entry the
> index actually describes is on image `00726` and reads *"John the sonne off Nicholas
> Horne bapt — Janua 10"*, 10 January 1616/17. The current position on the East Dereham
> register is in [the John Gurney case file](../../../case-files/john-gurney-case-file-v5.md)
> §5 and in [`research/topics/east-dereham-parish-register-paleography.md`](../../east-dereham-parish-register-paleography.md);
> the deviation audit is in
> [`research/people/g13-john-gurney/topics/identity/32-norfolk-parentage.md`](../../../people/g13-john-gurney/topics/identity/32-norfolk-parentage.md).
>
> The file is kept because the method it records — the crop, comparator and enhancement
> workflow, and the fact that a confident machine reading of a damaged hand can be wrong —
> remains useful. **Nothing in it should be cited as evidence.** The image references below
> point at media that stays in the website's asset tree.

---

This reference page preserves the technical AI workflow underlying the East Dereham parish-record analysis discussed in the [John Gurney Case File](/key-research/john-gurney-case-file.html). It was completed in **March 2026** using **ChatGPT Thinking v 5.4**, facilitated by **Allen Gurney**.
...
<div class="figure-stack">
  <figure>
    <img src="/media/east-dereham/john_gurney_fathername_composite_v3.png" alt="Comparator composite for the John Gurney father-name analysis">
    <figcaption>Same-hand comparator panel used in the father-name adjudication.</figcaption>
  </figure>
  <figure>
    <img src="/media/east-dereham/john_gurney_715_enhancement_sweep_v1.png" alt="Enhancement sweep for the John Gurney father-name zone">
    <figcaption>Reconstructed enhancement sweep for the ambiguous father-name zone.</figcaption>
  </figure>
  <figure>
    <img src="/media/east-dereham/line_05_enh_x3.png" alt="Canonical crop of the father-name line from the East Dereham register">
    <figcaption>Canonical crop retained for repeated review during the letterform analysis.</figcaption>
  </figure>
</div>
