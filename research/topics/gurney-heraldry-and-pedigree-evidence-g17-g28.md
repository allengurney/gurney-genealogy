# Gurney heraldry and pedigree evidence — G17–G28

## Finding

The G17–G28 corridor has enough heraldic and pedigree evidence to support a formal research layer, not just occasional narrative color. The recurring Norfolk Gurney shield is **Argent, a cross engrailed gules**. Daniel Gurney places the earliest mention in 1270, reports William de Gurnay's 1294 seal with the same coat, and rejects the Somersetshire Gournay paly shield as a Norfolk-family misattribution.[^dg-core]

Rye's published Norfolk Visitation extracts add useful differentiated forms: p. 132 gives the West Barsham / Cley / Cawston / Aylsham cadet pedigree with a crescent for difference; pp. 140–141 give the direct Anthony → Francis → Henry pedigree with a cinquefoil azure in dexter chief.[^rye]

The evidence does not prove the John Gurney-1 emigrant hypothesis. It does strengthen the English-side context above G14 Francis by showing that the West Barsham family was repeatedly recorded through shields, seals, pedigrees, church glass, and marital impalements.

## Generation map

| Gen | Person | Heraldic / pedigree evidence | Use | Caution |
|---|---|---|---|---|
| G28 | Sir William de Gournay II | No direct shield evidence located; immediately precedes the first explicit heraldic witness. | Genealogical bridge into the heraldic period. | Do not assign direct heraldic evidence to G28 yet. Katherine remains unresolved between Baconsthorpe / Ingoldesthorpe readings.[^g28] |
| G27 | Sir John de Gournay I | DG identifies him in an ancient roll with **Argent, a cross engrailed gules**; DG Supplement Note 113 compares the Gournay, Ufford, and Ingoldesthorpe engrailed-cross coats. | Earliest named direct-line heraldic anchor. | Norwich Cathedral engrailed-cross coffin-lid remains unattributed.[^g27] |
| G26 | Sir William de Gournay III | DG says the 1294 conveyance to John, Rector of Harpley, carried a seal with an engrailed cross. | Second early proof point: roll evidence followed by seal evidence. | Locate the deed or later description if it survives. |
| G25 | John de Gournay III | No separate shield evidence located; inherits Harpley after Rector John. | Continuity generation between the 1294 seal and later West Barsham transition. | Heraldic continuity is inferred, not independently witnessed. |
| G24 | John de Gournay IV | No separate shield evidence located; 1354 Harpley court anchors the line territorially. | Supports continuity of Harpley lordship before Edmund. | Search BL Add. MSS. 8841 for seals or heraldic detail. |
| G23 | Edmund Gournay | DG records Gurney cross-engrailed shield impaling Wauncy; visible in Gurney's Place, Norwich, and Denton church when DG wrote. | Major heraldic-marital hinge: Wauncy inheritance brings West Barsham. | Verify survival or later record of the Denton / Norwich glass.[^dg-g23] |
| G22 | Robert Gournay | No independent heraldic use located. | Succession-link generation after Sir John V's direct line failed. | Treat as genealogically crucial but heraldically thin. |
| G21 | Thomas Gournay I | DG pedigree identifies him as nephew and heir of Sir John V and says he used a gurnard fish in pale for a crest. | First explicit crest-related note in this part of the direct line. | Confirm whether evidence is seal, glass, tomb, or pedigree note only.[^dg-pedigree] |
| G20 | Thomas Gournay II | Armstrong's West Barsham church list later includes Jernegan/Jerningham among Gurney impalements. | Visual check on the Margaret Jerningham marriage. | Armstrong is an 18th-century witness, not contemporary to G20.[^west-barsham] |
| G19 | William Gurney IV | DG and Rye support the children/cadet-branch structure; Rye p. 132 gives crescent-differenced cadet shield. DG also reports the wrestling collar device/second crest. | Strong bridge between pedigree, device, and cadet sorting. | DG later corrected the p. 408 West Barsham slab as Wauncy, not Gurney.[^dg-correction] |
| G18 | William Gurney V | Marriage to Anne Heydon brings Heydon/Boleyn/Paston/L'Estrange context; DG plates include quarterings and impalements around pp. 415 and 418. | Marriage-network evidence, not only paternal-line evidence. | DG warns the Irstead tomb attribution is uncertain.[^dg-correction] |
| G17 | Anthony Gurney | Rye p. 140 starts the direct pedigree at Anthony and gives the cinquefoil-differenced form of the Gurney coat. | Best early-modern bridge from medieval heraldry to Tudor West Barsham / Great Ellingham line. | Treat cinquefoil as a differentiated visitation form, not a replacement for the base coat.[^rye] |

## Evidence layers to preserve

1. **Base coat:** Argent, a cross engrailed gules.
2. **Cadet form:** base coat with crescent for difference in Rye p. 132.
3. **Direct visitation form:** base coat with cinquefoil azure in dexter chief in Rye pp. 140–141.
4. **Crests/devices:** gurnard fish crest, later cap of maintenance, and wrestling collar device / second crest should remain separate from the shield blazon.[^dg-core]
...
The Gurney–Heydon bond behind this marriage layer is also documented at primary-deed level. On 25 March 1493 **Henry Heydon, knight** — Ann Heydon's brother and G18's brother-in-law — enfeoffed "Philip Calthorpp, esquire, James Hobert, Richard Southwell, **William Gurney**, John Heydon" and others of the **manor of Ormesby** with the advowson of Winterton and lands across the Flegg hundred: Henry Heydon placing a Gurney among the trustees of his own core estates, alongside a Calthorpe and the king's attorney Hobart, in the very decade the Heydon marriage matured. The same William Gurnay (elder or younger — the family head G19 and his son G18 were both then active as feoffees) recurs through the Calendar of IPM Henry VII holding lands for Townshend, Wynter, and the Fortescue trust that was settled on Dame Elizabeth, widow of that same Sir William Calthorp — so the deed and the calendar together show the West Barsham Gurneys operating as working trustees inside this cousinage, not merely tied to it by marriage.[^a7857-ormesby-heraldry]

[^a7857-ormesby-heraldry]: *A Descriptive Catalogue of Ancient Deeds in the Public Record Office*, vol. 4 (London: HMSO, 1902), A.7857, pp. 229–230, British History Online, https://www.british-history.ac.uk/descriptive-cat-ancient-deeds/vol4/pp218-235 (feoffment by Henry Heydon, knt., of the manor of Ormesby &c. in Flegg, 25 March 8 Henry VII / 1493; feoffees include William Gurney; abstract level). Verbatim abstract at [`sources/corpus_supplement/ancient-deeds-a7857-heydon-gurney-ormesby.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/corpus_supplement/ancient-deeds-a7857-heydon-gurney-ormesby.md); the wider Henry VII feoffee circuit at [`sources/corpus_supplement/bho-ipm-henry-vii-townshend-gurnay-feoffee.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/corpus_supplement/bho-ipm-henry-vii-townshend-gurnay-feoffee.md). Source IDs: `descriptive-catalogue-ancient-deeds`, `bho-ipm-henry-vii-townshend-gurnay-feoffee`.
...
- Prioritize G27/G26 as the earliest proof pair: roll evidence plus seal evidence.
- Use G23 as the West Barsham hinge because Edmund's Gurney/Wauncy impalement encodes the acquisition of the seat.
- Use G19/G17 as the visitation bridge because Rye provides both cadet and direct differentiated forms.
- Flag the West Barsham p. 408 slab image as Wauncy, not Gurney, wherever it is reused.
- Keep American or colonial-use questions separate from the English heraldic evidence.

## Conclusion

The heraldic material is strong enough to become a supporting architecture for G17–G28. It should not replace vital, probate, deed, or visitation evidence, but it can help correlate pedigree, marriage, place, and family-identity evidence across the medieval-to-Tudor Norfolk line.

---

[^dg-core]: Daniel Gurney, *The Record of the House of Gournay*, Part II (London: J. B. Nichols and J. G. Nichols, 1848), pp. 283–284. Corpus path: `sources/corpus/daniel-gurney-part-2.md`. Source ID: `dg-rec-pt2`.
[^dg-pedigree]: Daniel Gurney, *Record*, Part II, pp. 286–287, pedigree of the Gournays of Norfolk. Source ID: `dg-rec-pt2`.
[^dg-g23]: Daniel Gurney, *Record*, Part II, Edmund Gournay / Wauncy material; see also `data/ancestors.json` G23 and `research/places/west-barsham.md`. Source ID: `dg-rec-pt2`.
