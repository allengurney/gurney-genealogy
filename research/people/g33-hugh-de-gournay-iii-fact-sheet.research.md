...
The full Phase-0 cross-walks live in [`sources/FS/MZ68-VKD/assessment.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/FS/MZ68-VKD/assessment.md) (FS export, Pattou companion, Lorraine source) and [`sources/FS/Norman_additions/assessment.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/FS/Norman_additions/assessment.md) (Recherches PDFs and URLs). What follows is a synthesis fit for re-evaluation without re-reading those Phase-0 files; verbatim primary-source extracts are preserved where they bear interpretive weight.
...
Abbé J.-E. Decorde reports a separate Jumièges charter dated c. 1082 in which Hugh III de Gournay and his wife Basilie ratified the donation of one hundred and ninety arpents of land at **Boshyon** — the *Boscus Hugonis*, "Hugues's wood," lying south-south-west of Gournay-en-Bray (the modern commune of Bosc-Hyons, Seine-Maritime, INSEE 76124) — to the abbey of Jumièges, made by their vassal Raoul Havot. Decorde's text frames the place explicitly as *apud villam quæ vocatur Hugonis silva*.[^decorde-jumieges-1082-boshyon] This is the same charter as the undated Radulphus Havoth Jumièges charter preserved in the Rouen Archives paper cartulary (G32 companion §2.2), now dated by Decorde to c. 1082 and located at Boshyon; that entry's "undated" framing should be read against this Decorde dating and place-anchoring. The full diplomatic text, Basilia's own subscription, and the three-way dating analysis (editorial "1040" vs SCRIPTA's [1049–1087] vs Decorde's c. 1082) are at §3.4 below.

Basilea's Bec patronage continued alongside her son after Hugh III's retreat: Henry II's Bec confirmation (act DCCXLIV, Delisle n° 552) preserves a joint gift "ex dono Girardi de Gornaio et Basilie matris sue" of half the manor of Longueil, the church of Brannost, and the manor of Bosc-Girard — Basilea (as Gerard's mother) and Gerard giving together. Full treatment in `research/people/g32-gerard-de-gournay-fact-sheet.research.md` §2.10.1.[^dccxliv-basilea-g33]

Boshyon matters for the territorial reconstruction. It is the toponym from which the family's woodland holding takes its name (*Boscus Hugonis* = Hugues's wood, almost certainly Hugh I de Gournay), and the same place will reappear in two later Gournay-side endowments: in 1164 Hugues IV and Mélisende will assign three boisseaux of wheat and five of oats from their manor at Boshyon to the new church of Gaillefontaine, ratified by Archbishop Rotrou of Rouen; and in 1195 a neighbour, Manassès de Bully, will endow one *muid* of oats from the Boshyon mill for a perpetual altar lamp before St Hildevert's relic at the Gournay collegiate church. The 1082 charter is the earliest documented use of Boshyon as a Gournay-family endowment base. The detailed place narrative now lives at [`research/places/bosc-hyons.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/places/bosc-hyons.md).[^decorde-boshyon-endowment-chain]

[^decorde-jumieges-1082-boshyon]: J.-E. Decorde, *Essai historique et archéologique sur le Canton de Gournay* (Paris: Derache and Didron; Rouen: Lebrument, 1861); OCR text at `sources/corpus_supplement/essai-historique-archeologique-canton-de-gournay-decorde-1861.txt`. 1082 charter recorded by Decorde in the Boshyon parish entry; the deep-research synthesis ([`sources/corpus_supplement/deep-research-report-decorde-essai-gournay-ancestors.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/corpus_supplement/deep-research-report-decorde-essai-gournay-ancestors.md)) cleans the citation. Source ID: `decorde-essai-canton-gournay-1861`.
[^dccxliv-basilea-g33]: Delisle and Berger, *Recueil des actes de Henri II*, vol. 2 (Paris, 1920), act DCCXLIV (Delisle n° 552) at pp. 378–379: "Ex dono Girardi de Gornaio et Basilie matris sue, medietatem totius manerii de Longolio…Item ex dono ipsius Girardi et Basilie matris ejus, ecclesiam de Brannost…" Verbatim extract in `sources/corpus_supplement/actes-henri-ii-delisle-berger-vol2-text.md`. Source ID: `recueil-actes-henri-ii-delisle-berger-vol-2`.
...
### 3.4 Basilea charter-attested — the Jumièges family-group act, the 1112/13 Bec chain, and the generational reconciliation

Basilea is now anchored as Hugh III's wife by two independent charter witnesses, upgrading her from a compiled-pedigree figure (DG, FMG, Pattou) to a charter-attested one.

**Witness 1 — her own subscription in the Jumièges Havoth act.** In Ralph Havoth's oblation charter for Jumièges, Ralph gives land and tithes at "the villa called Hugh's Wood" (*Hugonis Silva*, the later Boshyon / Bosc-Hyons) "domino meo Hugone Gurnacensi et filio ejus Girardo et uxore ejus Basilia annuentibus" — "with my lord Hugh of Gournay and his son Gerard and his wife Basilia consenting" — and the signa include "**Signum Hugonis Gornaiensis. Signum Basilie uxoris ejus**": Basilia subscribes under her own name beside her husband, with Athelinus, treasurer of the Gournay church, confirming. The full diplomatic text is in repo via the Toronto DEEDS database (document 06400021); the original survives at Archives départementales de Seine-Maritime, 9 H 1747/1.[^deeds-jumieges-havoth]

**Witness 2 — "auia sua Basilia" in the Bec confirmation of 1112/13.** Henry I's confirmation for Bec, 11 February 1112/13, recites a clean three-generation chain: "**Hugo filius Girardi de Gornaco** concessit ea que **pater eius Girardus et Hugo de Gornaco auus suus et auia sua Basilia** dederunt ecclesie sancte Marie Becci" — Hugh son of Gerard de Gournay granted what his father Gerard, and Hugh de Gournay his grandfather and Basilia his grandmother, gave to Bec (Longueil; the grandfather's London holding "de rege Willelmo patre Henrici regis" and the church of Fordham in Essex; Gerard's "little manor" of Lessingham in Norfolk).[^deeds-bec-1112]

**The date question on the Jumièges act.** Three editorial datings circulate for the same charter:

| Dating | Authority | Note |
|---|---|---|
| "Assigned 1040" | DEEDS 06400021, reproducing an editorial assignment (the act sits at 1040 in Vernier's chronological arrangement; FMG's [875] carries the same 1040-dated version and already presumes it misdated) | If taken literally, the family group Hugh + wife Basilia + adult-consenting son Gerard existed by 1040 |
| [1049–1087] | SCRIPTA sc_151 — the modern Caen edition record for the same act | Wide bracket; comfortably contains 1082, excludes 1040 |
| c. 1082 | Decorde 1861, Boshyon parish entry (the 190-arpent Havot donation, §2.13 above) | Local-tradition dating of the same transaction, anchored at the same place |

The c. 1082 reading is adopted at roughly **80%** confidence, with most of the remainder (~15%) on another year inside SCRIPTA's 1049–1087 bracket and only ~5% on a genuinely early (pre-1051) act. The internal evidence is one-directional: Basilea was still Raoul de Gacé's wife until his death in 1051 (§3.1), so a 1040 "uxore ejus Basilia" is impossible for *this* Basilia; Gerard, giving adult consent, was born c. 1040–1050 and attests independently from 1082 (and possibly 1066×83 — see the G32 companion §2.1); and Decorde's c. 1082 dating fits both. A literal 1040 would require an otherwise unattested earlier homonymous trio (a different Hugh with a different wife Basilia and son Gerard), for which no evidence exists. The "1040" is an editorial call, not a charter date.[^jumieges-date-weights]

**The generational reconciliation — does the charter chain threaten the Hugh II / Hugh III ordering?** The two charters between them attest exactly three generations: Hugh (+ Basilia) → Gerard → Hugh. The repo's structure interposes a further Hugh — G34 Hugh II, the Mortemer 1054 commander — *before* this chain, so that the charter chain maps as G33 Hugh III (+ Basilea) → G32 Gerard → Hugh IV (senior line). That mapping is secure at each link: the grandfather Hugh of the Bec recitation is the donor of the London holding held "of King William" and of the Fordham church — the same donor William I's own confirmation for Bec names for London, Fordham, Ardleigh, and Liston (SCRIPTA Act 6512, §5.2 below), i.e. the Domesday Essex tenant, the repo's Hugh III; and the confirming grandson is the Hugh who was "of full age in 1112" and confirmed his father's and grandparents' Bec donations — the repo's Hugh IV, exactly as the G32 companion already records from DG (p. 111) and Decorde (the "c. 1112 or 1122" confirmation of the local tradition is this act, now dated 11 February 1112/13; see G32 §2.14). The charters neither attest nor exclude a Hugh a generation earlier: recitations of Bec's benefactions have no reason to name a man who gave Bec nothing. The earlier Hugh II rests on independent evidence — the 1035 Barfleur expedition captaincy, Mortemer 1054, the pre-Conquest Bayeux charters (c. 1060), an Avranches attestation of 1037×1048 ("S Hugonis Gornai," Norman Episcopal Acta, identified in the DEEDS sweep, full text not pulled), Wace's "li vieil Hue" at Hastings, and Pattou's and Potin's explicit two-generation treatment with Hugh II dying c. 1074. The repo's interleaved ordering is retained at roughly **85–90%**; the collapsed one-Hugh alternative (~10–15%) would require a single man born by c. 1015, commanding at Mortemer, marrying the widow Basilea after 1051 in his late thirties or forties, fathering Gerard c. 1040–50 (i.e. *before* that marriage — a further strain), attesting to 1087, and dying a Bec monk in 1110 at about 95. No structural change to the ancestor spine is warranted; the one development that would reopen the question is a firm pre-1051 date for the Havoth act from the original (AD76 9 H 1747/1) or from SCRIPTA's edition apparatus.[^reconciliation-weights]

**Numbering-offset caution.** External works number these Hughs differently — Keats-Rohan's and Normonde's "Hugh I / Hugues Ier" and OpenEdition's "Hugues II" are all the repo's Hugh III, and accounts that treat the 1112/13 confirmer as "Hugh III" make Basilea's husband "Hugh II." When reading any external charter discussion, anchor identifications by relationship and date (Basilea's husband; Gerard's father; the 1112 confirmer), not by the numeral.

[^deeds-jumieges-havoth]: *Chartes de l'Abbaye de Jumièges (v. 825 à 1204)*, t. 1, ed. J. J. Vernier (1916); original at Archives départementales de Seine-Maritime, 9 H 1747/1; full text as transcribed in the University of Toronto DEEDS database, document 06400021, https://deeds.utsc.utoronto.ca/charters/06400021 ("assigned 1040" — editorial; see the date discussion in this section). Same act in SCRIPTA as sc_151, dated [1049–1087] (https://mrsh.unicaen.fr/scripta/doc/sc_151.html), and known to DG (1845, p. 57, from "an old copy in a paper Cartulary of Jumièges," Rouen Archives = FMG [876], undated version) and to Decorde 1861 (c. 1082, Boshyon entry). Verbatim text: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source IDs: `deeds-utoronto-gournay-charter-extracts`, `unicaen-scripta-selected-gournay-acts`, `decorde-essai-canton-gournay-1861`, `fmg-medlands-normacre`.
[^deeds-bec-1112]: *Regesta Regum Anglo-Normannorum*, vol. 2 (Regesta Henrici Primi), ed. Davis/Johnson/Cronne (1956); full abstract as transcribed in the DEEDS database, document 03781013, https://deeds.utsc.utoronto.ca/charters/03781013; confirmation by Henry I, 11 February 1112/13. Verbatim text: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source ID: `deeds-utoronto-gournay-charter-extracts`.
[^jumieges-date-weights]: Date-weighting synthesis from: SCRIPTA sc_151 bracket [1049–1087] (Source ID: `unicaen-scripta-selected-gournay-acts`); Decorde 1861 c. 1082 dating and Boshyon place-anchoring (Source ID: `decorde-essai-canton-gournay-1861`); FMG MedLands [875]–[876], which already presumed the 1040-dated version misdated because "Gerard cannot have been adult in 1040 if he was witnessing in 1082" (Source ID: `fmg-medlands-normacre`); Raoul de Gacé's 1051 death per Potin 1842 p. 109 (Source ID: `dg-recherches-potin-1842`).
[^reconciliation-weights]: Chain-mapping evidence: SCRIPTA Act 6512 for the London/Fordham/Ardleigh/Liston donor (Source ID: `unicaen-scripta-selected-gournay-acts`); DG 1845 p. 111 (Hugh IV "of full age" 1112) and Decorde 1861 (the Hugues IV Bec confirmation of local tradition, c. 1112/22) — see the G32 companion §2.14 (cross-reference, not a source); for the independent Hugh II evidence, the G34 companion §§2–6 (1035 expedition, Mortemer, Bayeux charters, Wace, Pattou/Potin — cross-reference, not a source) and DEEDS sweep item 06081055 (Avranches 1037×1048 attestation, Norman Episcopal Acta ed. Allen 2009, identified but not pulled — the pull, with the sc_151 date-apparatus check that is this section's named reopening trigger, is tracked in the leads catalog<!-- L-247 -->; Source ID: `deeds-utoronto-gournay-charter-extracts`).
...
A chancery-era use of the epithet is now in repo: a Regesta Henrici Primi confirmation of 1123×1128 recites that "**Hugo senex de Gornaco**" granted a house in Escuceio, "and his successors" granting after him. The grant is recited in the past tense ("dedit"), so the act shows "senex" in use as a generational disambiguator for a *past* Hugh donor — by 1123 both Hugh II (d. c. 1074) and Hugh III (d. 1110) were dead, and the recitation does not by itself settle which of them the scribe meant. It confirms the epithet's documentary currency without disturbing the Wace/Pattou/Potin case for locating the full epithet stack at Hugh II.[^deeds-hugo-senex]

[^deeds-hugo-senex]: *Regesta Regum Anglo-Normannorum*, vol. 2 (Regesta Henrici Primi), 1123×1128 royal confirmation; summary and witness list as transcribed in the DEEDS database, document 03781569, https://deeds.utsc.utoronto.ca/charters/03781569 (witnesses include Geoffrey archbishop of Rouen, John bishop of Lisieux, Humphrey de Bohun, Robert earl of Leicester, Nigel d'Aubigny). Extract: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source ID: `deeds-utoronto-gournay-charter-extracts`.
...
Second, William I's [1081-1087] confirmation of Bec's English holdings gives the fuller English-side wording: the king confirmed to Bec what Hugh de Gornaco had given, including "in London' quod ibi habebat de me" - whatever Hugh held there of the king - and, in Essex, Fordham's church and church land with all tithe and one villanus, Ardleigh's tithe and one villanus, and Liston's half-vill tithe, half church, and one villanus. The London holding is now doubly attested: Henry I's Bec confirmation of 1112/13 recites the same gift a generation later — the grandfather Hugh gave Bec "quod habebat in Londonia de rege Willelmo patre Henrici regis" (what he had in London of King William, father of King Henry) together with the church of Fordham (§3.4).[^scripta-bec-6512][^deeds-bec-1112-london]

[^deeds-bec-1112-london]: DEEDS document 03781013 (Regesta Henrici Primi, Henry I confirmation for Bec, 11 Feb 1112/13). Extract: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source ID: `deeds-utoronto-gournay-charter-extracts`.
...
The 1067 Saint-Benoît-sur-Loire charter is **earlier than the 1076 Bec charter** previously treated as the earliest datable Hugh-III appearance. Its fuller context is now in repo via DEEDS document 05390078: William the Conqueror's April 1067 donation of church properties and castle revenues to Fleury/Saint-Benoît, "Signum Hugonis de Gornaio" among the witnesses beside Gerald de Novomercato, Stigand the *dapifer* (steward), and Henry de Ferrers, with the royal family subscribing.[^deeds-1067-fleury]

A further act of the same bracket adds a named kinsman: a Regesta Willelmi Conquestoris royal decree of 1068×1076 (a grant to a female monastery of the Virgin, probably Montivilliers) carries the consent clause "**concedente Hugone de la Ferteit et Hugone de Gornay**" — with Hugh de la Ferté and Hugh de Gournay consenting — and names "**Warnerio consanguineo**," a kinsman Warner, in the same transaction context. This pairs the Gournay lord with the la-Ferté collateral in a single consent clause and adds Warner to the small set of contemporarily named Gournay kin. Which Hugh consented is formally ambiguous within 1068×1076 (Hugh II died c. 1074), but the attestation series of the later 1060s–1080s belongs most naturally to Hugh III as active family head; the attribution caveat for the whole 1067–1087 series is discussed at §3.4.[^deeds-warner-kinsman]

[^deeds-1067-fleury]: *Recueil des chartes de l'abbaye de Saint-Benoît-sur-Loire* (Prou/Vidier); summary and witness context as transcribed in the DEEDS database, document 05390078, https://deeds.utsc.utoronto.ca/charters/05390078 (April 1067, regnal year VII of King Philip). Extract: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source IDs: `deeds-utoronto-gournay-charter-extracts`, `fmg-medlands-normacre`.
[^deeds-warner-kinsman]: *Regesta Willelmi Conquestoris et Willelmi Rufi 1066–1100*, royal decree 1068×1076; summary as transcribed in the DEEDS database, document 03771092, https://deeds.utsc.utoronto.ca/charters/03771092 (places named: Monasterium Villare, Fécamp, Eschetot, Magneville, Caen, Longueville, Rouen). Extract: `sources/corpus_supplement/deeds-utoronto-gournay-charter-extracts.md`. Source ID: `deeds-utoronto-gournay-charter-extracts`.
...
| DEEDS (Toronto) Gournay charter extracts — Jumièges 06400021, Bec 1112/13 (03781013), Hugo senex (03781569), Fleury 1067 (05390078), Warner kinsman (03771092), and the sweep index | `deeds-utoronto-gournay-charter-extracts` |
