...
Research companion for `g22-robert-gournay-fact-sheet.md`. See `.claude/rules/research-files.md` for the paired-file rule.
...
[^mmc-cipm-2026]: "Browse Inquisitions," Mapping the Medieval Countryside (E-CIPM), accessed 22 May 2026, [https://inquisitionspostmortem.ac.uk/browse/inquisitions/](https://inquisitionspostmortem.ac.uk/browse/inquisitions/). Search performed for `Gurney`, `Gurnay`, `Gournay` — all returned no matching records out of 7,565 indexed entries.
