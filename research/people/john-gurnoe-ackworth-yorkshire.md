...
The 1636 Mary Burton wife match is strong enough on its own to keep this household above the noise floor — the older compiled family histories sometimes referred to a Mary Barton or Mary Burton wife for the colonial John, and the Ackworth marriage now supplies a primary record of that combination at the right date. The household's disappearance from indexed Yorkshire records after 1637 is also emigrant-shaped. The case file (v4.3, §8 and §11) accordingly carries Ackworth at **Unlikely (~3%)**, the highest of the non-Candidate-B named rows — capped there because the colonial John's marriage to Mary is bounded before 1628 by his daughter Mary's chronology, so the 1636 Ackworth bride fits only as a hypothetical second wife, and a 1637 son christened John Thomas collides with the colonial son John Jr. (b. c.1633).
...
- Provenance of the "Mary Barton/Burton (m. 1636)" tradition: identify the earliest compiled-genealogy occurrence of the claim that the colonial John's wife was Mary Barton/Burton. If the tradition predates modern index availability, it is independent evidence pointing at Ackworth and this household's probability should rise materially; if it first appears in IGI-era derivative trees, it is circular (early compilers matching the same Ackworth index entry) and the row stays low. Google Books pass (Available online); Rigler 1994 and older American Gurney compilations (Unknown online).
