...
Research companion for `g16-francis-gurney-fact-sheet.md`. See `.claude/rules/research-files.md` for the paired-file rule.

---

## Working Notes

### Anthony G17's will (Dec. 1557) does not name Francis — what that does and does not mean

Anthony Gurney's newly transcribed will (made 6 December, proved 10 December 1557 — see the [G17 companion](https://github.com/allengurney/gurney-genealogy/blob/main/research/people/g17-anthony-gurney-fact-sheet.research.md) and [`sources/corpus_supplement/ncc-will-1557-anthony-gurney-great-ellingham-transcription.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/corpus_supplement/ncc-will-1557-anthony-gurney-great-ellingham-transcription.md)) **names no living son** — consistent with Francis having died *vita patris*, as Blomefield, the visitation, and Daniel Gurney all state. The death bound moves with the father's: Francis died **before December 1557** (previously expressed as "before 4 January 1555/6"; the earlier bound may still hold if the county-history tradition reflects a real event, but the will date is the secure terminus).

The will's beneficiaries fit Francis's family group well. It funds "the educating and bringing upp of Anthonye Gurney, Thomas Gurney, Elizabeth Gurney, ffrances Gurney, Anne Gurney and Anthonye Drurye my Grandchildren." Setting aside Anthony Drury (a daughter's son), the five Gurney grandchildren plus **Henry (G15) — the heir at law, who took the descended third under the Statute of Wills and so needed no mention in the will** — make **six grandchildren, matching Pease's six-children list for Francis**. On that reading the will independently corroborates Francis's family group, and the grandchild "ffrances" is Francis's own child Francis (or Frances). The lineage Anthony → Francis → Henry remains supported by at least four independent witnesses (the branch arms, the 1563/1589/1613 visitation pedigree, Blomefield, Daniel Gurney's *Record*, plus Pease); the will's silence on Francis is the expected silence of a settlor whose son is dead and whose heir takes by descent, not evidence against the line. Reconciliation work — matching the five named grandchildren one-to-one against Pease's list, and explaining the county histories' 1555/6 death tradition — remains open.<!-- discovery trail: lead L-112 (high priority) -->[^anthony-will-g16]

[^anthony-will-g16]: Will of Anthony Gurney of Great Ellingham, Esq., 6 Dec. 1557, proved Norwich 10 Dec. 1557; Norwich wills register, FamilySearch film 008076312, images from [ark:/61903/3:1:3Q9M-CSND-MSDX-K](https://www.familysearch.org/ark:/61903/3:1:3Q9M-CSND-MSDX-K?view=fullText); full transcription in the corpus supplement linked in the body. Statute of Wills (1540): a testator could devise two-thirds of land held by knight service; the remaining third descended to the heir at law. Source ID: `familysearch-fulltext-search`.
