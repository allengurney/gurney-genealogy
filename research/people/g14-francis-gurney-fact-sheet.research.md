...
Research companion for [`fact-sheets/g14-francis-gurney-fact-sheet.md`](https://github.com/allengurney/gurney-genealogy/blob/main/fact-sheets/g14-francis-gurney-fact-sheet.md). See `.claude/rules/research-files.md` for the paired-file rule.

Francis G14 (1581 – 9 January 1646/7, burial at St Botolph Bishopsgate per FreeREG, correcting Boyd's 1641 — see Lineage status below) was the Merchant Taylor of St Benet Fink, London, sixth son of Henry Gurney G15 of Great Ellingham and West Barsham, and the probable father of John Gurney-1 of Massachusetts. The two-Francis problem (this G14 Merchant Taylor of St Benet Fink vs. the contemporaneous St Giles Cripplegate laceweaver Francis, wife Mary) and the Candidate B framing are treated with their sources here and in the [case file](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md), not re-derived.

---

## Working Notes

### Visitation of Norfolk confirms "6. Francis, of London"
...
### East Dereham children

Francis G14's documented East Dereham child set is grounded in the parish-register crops at `sources/media/Parish_Register_East_Dereham/`, cross-checked against FamilySearch index entries in the England, Norfolk, Parish Registers (County Record Office), 1510-1997 collection and against the register's reconstructed chronology lattice in [`sources/validations/east-dereham-pd-86-41-register-structure-and-chronology.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/validations/east-dereham-pd-86-41-register-structure-and-chronology.md). Paleographic work changed the event class of two entries (baptism → burial), reread Entry B's relationship (from daughter to likely a niece in Francis G14's household), and corrected Entry D's page and date; the given names are unchanged.<!-- Merges two 2026-05-15 working passes — a first index-expansion/reclassification pass and a later focused-sweep refinement that superseded parts of it (Entry B re-read from confirmed daughter to likely niece; the held "Margaret" 00732 baptism lead refuted and resolved to "Marye" as Entry D). Superseded readings are stated below in corrected form; the trail is in the cited footnotes. -->

- **Entry A — Edward (baptism).** FamilySearch index VNN2-SCF, FS-indexed 27 May 1610. The year inherits from a modern margin annotation on the register page rather than a contemporaneous register-year heading, and Entry A sits in the pre-00726 portion of the register where the chronology lattice does not extend back with the same confidence; the case file's ±2–3 year margin on East Dereham dates remains the correct posture.[^fs-east-dereham-children-2026]
- **Entry B — Marye (burial, page 00725).** Reclassified from baptism to burial: page 00725 sits in a burial subsection of the 25 March 1615 – 25 March 1616 OS register year. FS index VNN2-WR2; the line reads "Marye … of ffrancis Gurny" (25 January; year not in the register), the relationship word partly obscured by staining. A 4× magnification of that relationship token (`page_00725_marye_relationship_token_magnification_sweep.png`) shows a 4–5 character-width word whose opening-letter shape refutes 'daughter' and is class-consistent with niece/nephew; Entry B is therefore best read as a Francis G14 household-event entry (likely a niece), not a confirmed daughter. The burial-month token is four character widths and refutes a spelled-out 'January' — compatible with an abbreviated Iany/Jany (late January 1616 modern) or with a mid-summer Iuny/Iuly (June/July 1615 modern).[^fs-east-dereham-children-2026][^east-dereham-paleographic-2026]
- **Entry C — Agnes (burial, page 00725).** Reclassified baptism → burial. FS index VNN2-WRG; the line immediately below Marye reads cleanly "Agnes the daughter of ffrancis Gurny" (31 January = 31 January 1616 modern) and stands as a confirmed daughter. VNN2-WRG transcribes "Susan Gurney," but the underlying register entry reads Agnes — an indexer mis-read; the earlier working hypothesis of a previously-undocumented daughter Susan is therefore void.[^fs-east-dereham-children-2026]
- **Entry D — Marye (baptism, 25 May 1618, page 00732).** A focused six-state sweep (`page_00732_line_margaret_ffrancis_gurnoe_sweep.png`) resolves the candidate line as "Marye the daughter of ffrancis Gurnoe bapt may 25"; page 00732 sits in the 1618 register year, locking the date to **25 May 1618** modern. (An earlier 00736 page attribution was a working assumption; 00736 is in fact the 1620 christenings page, headed "Billes Indented of all the Christnings, Marriages and Burialls in East Dereham 1620.") The surname terminal is paleographically `Gurnoe` (open `-oe` form); `Gurney` is a downstream-normalization candidate (Source ID `fs-vnn2-4vc-marye-gurney-baptism-east-dereham`). An earlier provisional reading of this same 00732 line as "Margaret" — which, had it held, would have implied a daughter named for the first wife Margaret Rybett and so her death before the baptism — is withdrawn: the sweep refutes 'Margaret' on word length and terminal and reads 'Marye'. There is thus no previously-undocumented daughter Margaret arising from this image, and the original Margaret Rybett burial question remains open and unresolved by the East Dereham image set reviewed to date.[^east-dereham-margaret-bapt-lead][^east-dereham-paleographic-2026]
- **Entry F — Francis (probable son; burial 8 November 1633).** FS index VNN2-H8S, no parent named in the index. The probable-son-of-Francis-G14 reading rests on Francis G14's documented East Dereham residence in those years; on elimination of competing Francis Gurney identifications (Francis G14 himself died 1646/7 at St Botolph Bishopsgate, London; Francis B "the laceweaver" was at Norwich St Peter Mountergate); and on Francis G14's documented name-reuse for the 1628 St Benet Fink Francis baptism (Bernau 1913). Estimated age at death is ~15–22 if born at East Dereham c.1611–1618.[^fs-east-dereham-children-2026]
...
- Entry A (Edward, 00721 baptism) sits in the pre-00726 portion of the register, where the lattice does not extend back with the same confidence; case-file ±2–3 year margin applies.

From page 00726 the register is laid out as combined annual returns (christenings + marriages + burials per page), with an inline "Mariages" subsection header. The 1617 annual-return marriages subsection (pages 00728–00730) contains no Gurney candidate; the other annual returns' marriages subsections (1616, 1618, 1619, 1620, and any pre-00726 marriages) remain unscanned and are the most direct path for testing whether Francis G14 and Margaret Rybett married at East Dereham.[^east-dereham-paleographic-2026]
...
That notice strengthens the social setting already known from Daniel Gurney: Francis's agency for the Lestranges was not an isolated employment relationship but sat inside a dense cousinage linking the Gurneys, Lewkenors, Lestranges, Stubb(e)s, Calthorpes, and Heydons. The numbered jests themselves name **Fra. Gurney** (No. 120, "an uncle of Edward, and a merchant in London" = Francis G14), **Ed./Ned Gurney** (Edward of West Barsham, d. 1641), **Tho. Gurney** (his brother), **Dol. Gurney** (Dorothy, his sister, died single), and **Ed. Gurney** the rector (Edmund the Divine); **no John Gurney appears**. Roster: [`sources/corpus_supplement/lestrange-anecdotes-gurney-roster-thoms-1839.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/corpus_supplement/lestrange-anecdotes-gurney-roster-thoms-1839.md).

The 1606–26 account transcription now makes Francis’s role concrete: 31 linked entries show him supplying goods, receiving bills, paying London creditors and the East India Company, receiving goods at “Mr Gurney’s,” and carrying credit obligations with Lock and the town of Lynn. Lock and Lawrence Michael are both indexed as London-based tailors and moneylenders; the latter was also master to John Spratt in a documented 1616 L’Estrange apprenticeship payment. These are direct business-network facts, not evidence that John or Edward Gurney lived with either man or trained under him. The most consequential original-account targets are `LEST/P7` section 027 for the 1614–22 agency and apprenticeship sequence, section 043 for the 1625 Lynn obligation, and section 045 for the 1626 Smith–Drury payment. Full analysis: [`research/topics/francis-gurney-lestrange-household-network.md`](../topics/francis-gurney-lestrange-household-network.md).[^lestrange-ukda-g14]
...
[^lestrange-ukda-g14]: Jane Whittle and Elizabeth Griffiths, *Household Accounts of the Le Strange Family, 1606–1626*, UK Data Archive Study 5726 (2006), local database joined across account, people, place, category, and document-reference tables; study guide [PDF](https://doc.ukdataservice.ac.uk/doc/5726/mrdoc/pdf/guide.pdf), pp. 1, 3–8. Source ID: `ukda-5726-lestrange-household-accounts-1606-1626`.
...
Bernau states that Francis G14 was "a member of the Merchant Taylors' Company, and a merchant living in the parish of St. Benet Finck, London, the sixth son of Henry GOURNAY, of Great Ellingham and West Barsham, Norfolk."[^bernau-parentage] This is an independent 1913 attestation of Henry G15's paternity of Francis G14, sourced separately from Daniel Gurney (1848) and from Blomefield. It carries no new detail but closes the source triangulation: parentage is now attested by Daniel Gurney (1848), Blomefield, the 1633 or 1634 Heralds' Visitation of London (see conflict below), and Bernau (1913).

[^bernau-parentage]: Bernau, *British Archivist* I.7, "His Parentage" section. The sixth-son count agrees with Daniel Gurney, *Record*, Part III, pp. 525–526 (`sourceId: dg-rec-pt3`).

### Heralds' Visitation date — conflict flagged

Bernau dates Francis's attestation of the Gourney pedigree to the **1634** Heralds' Visitation of London.[^bernau-visitation] The current fact sheet and [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md) both use **1633**.[^fs-visitation] The John Gurney Case File cites "Heralds' Visitation of London, 1633; DG Record" for Roger as "eldest sonne."
...
[^fs-visitation]: [`fact-sheets/g14-francis-gurney-fact-sheet.md`](https://github.com/allengurney/gurney-genealogy/blob/main/fact-sheets/g14-francis-gurney-fact-sheet.md), Timeline and Highlights sections; [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md), §2.4 and Master Timeline.
...
3. It is independently relevant to the Essex / Braintree Massachusetts social-network argument in [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md) §10.3, which notes the Browning surname recurring in Coleman Street emigrant contexts.
...
[^bernau-spelman]: Bernau, *British Archivist* I.7, "His Parentage" section.
...
|---|---|---|---|
| Dorothy | 2 March 1619 | St Benet Fink | Both sources; Bernau adds "Living in 1634 (Visit. London)."[^kid-dorothy] |
| Roger | 27 December 1621 | St Benet Fink | Both sources. Bernau: "Living 1634, then described as eldest son and heir (Visit. London)."[^kid-roger] |

**Entries in Bernau that do not appear on the current fact sheet:**

| Child | Baptism (Bernau) | Parish | Note |
|---|---|---|---|
| Frances | 18 January 1626; buried 30 September 1626 | St Benet Fink | Female; died the same year. Fact sheet instead lists a "Francis" (male) baptized 13 December 1625 — almost certainly the same register entry read differently. See analysis below.[^kid-frances] |
| Francis | 13 November 1628 | St Benet Fink | This is the younger Francis, subject of Bernau's article. **Not on the current fact sheet.** The fact sheet's 1628 entry is "Anne (second), 14 September 1628" — a different child. Both may be correct; see analysis below.[^kid-francis-1628] |
| Lucretia | 28 October 1630 | St Benet Fink | "Living in 1634 (Visit. London)." Fact sheet has "Margaret, 10 September 1630" at the same parish in the same year — different child, different month. See analysis below.[^kid-lucretia] |
| Thomas | 19 April 1636 | St Benet Fink | Noted as receiving letters of administration for his brother John of Maldon in 1681. Not on the fact sheet.[^kid-thomas] |
| Margaret | 28 July 1637 | St Benet Fink | Fact sheet has "Mary, 19 December 1637" at the same parish in the same year — again, different name and date.[^kid-margaret-1637] |
| Anne (probably eldest) | c. before 1619 | — | "Living in 1634 (Visit. London)." Bernau groups this conjecturally with the other children; it may correspond to the fact sheet's Anne "c. 1624" or to an undocumented elder daughter.[^kid-anne-eldest] |
| John | after 1634 | London (baptism not given by Bernau) | Died a bachelor at St Mary's, Maldon, 1681. See "The second John" below.[^kid-john-second] |
...
- Richard Gurney of Maldon (mentioned in Maldon corporation accounts 1677; named in Michael Cooper's will dated 18 Feb 1687 proved 26 April 1688 in the Commissary Court of London–Essex & Herts, "Hamor" 207).[^kid-richard-speculative]
- George Gurney, who married Mary Elliston, widow, at St Peter's Maldon in 1660; his son George was baptized at the same church the following year.[^kid-george-speculative]
...
[^bernau-kids-caveat]: Bernau, *British Archivist* I.7, "His Parents' Children" section, opening sentence.
[^kid-dorothy]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 1.
[^kid-roger]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 2.
[^kid-frances]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 3.
[^kid-francis-1628]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 4: "Francis, baptized at St. Benet Finck 13th November 1628. Of whom hereafter." The full Maldon biography follows in the same article.
[^kid-lucretia]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 5.
[^kid-thomas]: Bernau, *British Archivist* I.7, §"His Parents' Children," item 6; cross-referenced in item 9 and in the biography of Francis of Maldon below.
...
1. **Chronology.** An emigrant arriving in Weymouth by June 1641 (Candidate B framework, `g13-john-gurney-fact-sheet.research.md`) cannot be the same person as a man still at Maldon in 1674 paying nine hearths of tax.
2. **Life status.** Allen's G13 was married with at least five English-born children before 1640; Bernau's second John died a bachelor.
...
This second John is added as a row in the elimination table of [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md) §8.
...
- **Dr. Thomas Browning, D.D.** (c. 1615 – 1694), B.A. Pemb. Coll. Cambridge 1635, incorporated M.A. 1 February 1642/3, D.D. per *literas Regias* 1660, rector of Wickham Bishop, Essex, 1661.[^tb-dnb] Bernau notes that Francis-the-elder's daughter Anne (the 1634-living eldest, or another Anne) may have married Thomas Browning, making the two Brownings — William's line and Thomas's line — connected to the Gurneys through a sister-pair marriage (Anne Browning to Francis G14, Anne Gurney to Dr. Thomas Browning).[^tb-sister-pair]
- The will of Henry Jermyn of Wickham Bishop, dated 1680 (proved Commissary Court of London–Essex & Herts, "Heydon" 481), names "Dr. Thomas BROWNING and Anne, his wife" — documentary anchor for the sister-pair hypothesis.[^tb-jermyn-will]
- Thomas Browning's own will, dated 16 June 1694 and proved 3 May 1705, names his daughter Ann as the wife of the Rev. Christopher Wragg of Little Wigborrow, Essex. Bernau notes disappointingly that the will "makes no mention of the GURNEYS."[^tb-will]
...
[^tb-dnb]: Bernau, *British Archivist* I.7, "Thomas Browning, D.D." section, citing Foster's *Alumni Oxonienses*.
[^tb-sister-pair]: Bernau, *British Archivist* I.7, "Thomas Browning, D.D." section: "It is possible that Francis GURNEY and Anne, his sister, may have married a sister and brother, Anne BROWNING and Dr. Thomas BROWNING."
[^tb-jermyn-will]: Bernau, *British Archivist* I.7, "Thomas Browning, D.D." section, citing Commissary Court of London–Essex & Herts, "Heydon" 481.
[^tb-will]: Bernau, *British Archivist* I.7, "Thomas Browning, D.D." section.
...
**Francis G14's own identity is confirmed; the link from him to John Gurney-1 of Massachusetts is not.** His parentage, occupation, marriages and death date are documented across Daniel Gurney (1848), the Norfolk historian Blomefield, the 1633/34 Heralds' Visitation, his Merchant Taylors' Company admission of 1606, the Hunstanton Hall Lestrange account book (1612–1636), his St Botolph Bishopsgate burial of 9 January 1646/7, and the genealogist Bernau (1913).

**The lineage to John Gurney-1 is the leading identification and it is unproven, at about eleven percent.** Two things bound it. **No record names a John among Francis's children** — not the Heralds' Visitation, not the St Benet Fink register, not either compiled account. And **the East Dereham register cannot supply one**: its annual returns for 25 March 1611 to 25 March 1616 are lost, the parish has no bound register between 1596 and 1679, and its diocesan transcripts begin only in 1698, so the years in which a first child of the 1611 marriage would fall are permanently unobservable. A line in that register long read as "John the sonne of ffrancis Gurnie" does not support the identification: re-read across the full image run against recorded coordinates, the line adjudicated belongs to an Enderby family, and the record the index describes is six years later and belongs to a Horne family.[^east-dereham-limits] The whole field of candidates is weighed in [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md) §11.
...
- Bernau did not examine the East Dereham register. His "There is no complete record of the children" caveat is correct for St Benet Fink alone; the East Dereham Norfolk children — Edward (baptised 27 May 1610), the Marye buried in 1615/16, Agnes (buried 31 January 1616) and Marye (baptised 25 May 1618) — lie outside Bernau's source base.

[^east-dereham-limits]: Norfolk Record Office, East Dereham, "Indented register bills, 1593-1641" (PD 86/41), read across all 110 catalogued images with years taken from in-parchment headings only; the file runs from the 1610 return directly to the 1616-17 return. Norfolk Record Office, *Parish Registers and Transcripts in the Norfolk Record Office* (summary, revised 12 October 2022), entry for Dereham, East (PD 86): registers "c 1549-1596 unfit for production," then 1679 onward; archdeacon's and bishop's transcripts 1698–1885. The re-reading of the disputed line is the deviation audit of 22 July 2026, worked against recorded image coordinates. Source ID: `nro-pd-86-41`.
...
1. Reconcile the 1633/1634 Heralds' Visitation date against the Harleian Society transcript of the London visitation (vol. XV, 1880; vol. XVII, 1883; Fellows 1957 supplement).
...
3. Locate the manuscript Gurney/Gournay pedigree given by "a Francis Gournay" to Sir Henry Spelman — candidate repositories CUL MS Add., Bodleian MSS Eng. hist., BL Add. MSS (Spelman transcripts), College of Arms.
4. Pull PCC or Commissary Court records for Henry Jermyn's will 1680 ("Heydon" 481) and Thomas Browning's will 1694/proved 1705, both in Comm. London–Essex & Herts.
5. Search Wickham Bishop and adjacent Essex parish registers for an Anne Gurney / Thomas Browning marriage c. 1635–1645.
...
- Active case file: [`research/case-files/john-gurney-case-file-v5.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v5.md)
