...
Research companion for `g08-amos-gurney-fact-sheet.md`. See `.claude/rules/research-files.md` for the paired-file rule.
...
This is family-tradition language inherited from <code>data/ancestors v26.json</code>. The 1810 federal census is the next test — does Amos appear at Cummington in 1810? If he is gone, the move was 1802–1810. If he is still there, the family-tradition phrasing is wrong or refers to a temporary departure.
