...
Earlier version of this companion miscited DG-II references (pp. 325–355) as "DG Supplement (1858)" — those pages are below the Supplement's range (725–1096) and are in Part II. The p. 786 Supplement citation is correct (within range). Corrected. See `research/topics/dg-citation-audit.md`.
