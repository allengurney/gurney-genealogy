...
|---|---|---|---|---|
| `fact-sheets/g13-john-gurney-fact-sheet.md` | fact_sheet | 176 | re-frozen at G13 cutover 2026-07-13; approved about-65% publication edit (prior c9006ce6 baseline retained in legacy baseline metadata); re-frozen 2026-08-01 (prompt-B tranche C: birth vital corrected to about 1603 in England, East Dereham removed, Peter/Isaac sweep note added, case-file v4→v5 swap) (prior baseline `259606fdb742…`) | `02039a656f4bfa95d86eb98d2d7d6440b4fd1c447ba8c9eebfc9c3f35b93710a` |
| `research/case-files/_legacy/john-gurney-case-file-v4/john-gurney-case-file-v4.md` | case_file | 1007 | clean @ c9006ce6; retired to `research/case-files/_legacy/john-gurney-case-file-v4/` at prompt-B tranche B, 2026-07-30; frozen content unchanged, path updated 2026-08-01 | `5237df2d9e97e401439c8225ad1e037fb3edbc7475703bfe882ba21fd0b7e679` |
| `research/topics/g13-john-gurney-immigration-by-association.md` | existing_topic | 163 | clean @ c9006ce6; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `daf224d41e1b…`) | `e7f11bd042ea92d20397d85452dea018064bf5b9d027cf1dc1aa38ba77c0efe9` |
| `research/topics/john-gurney-candidate-aylesbury-buckinghamshire.md` | existing_topic | 62 | clean @ c9006ce6; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `a57093b226c3…`) | `1958f54e244d347e95eee2701605155e5fa6154eaf350beef6dbe353be838acc` |
| `research/topics/john-gurney-candidate-berkhamsted-hertfordshire.md` | existing_topic | 21 | clean @ c9006ce6; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `48a4d4e36fc8…`) | `a064228940a8944a6950cc0ad74083b064c73279a7ddcfbbd95ee5265e63eabd` |
| `research/topics/john-gurney-candidate-ackworth-yorkshire.md` | existing_topic | 28 | clean @ c9006ce6; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `88bbb4de8395…`) | `425fbbe3925354c9f8dbf9df6de8d5edbf3ed6407599e16352e5a572e22a3b2e` |
| `research/topics/john-gurney-candidate-earsham-norfolk.md` | existing_topic | 64 | re-frozen 2026-07-19 after post-freeze Syon-chain/wife-sequence additions (July 2026 campaign; new material is lead-tracked, not silently folded into the refactor); re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `660eaf358240…`) | `75481220a126028a387fcdef8ad5152fdfb49ef9db8fe4c7cb38c69d295bf334` |
| `research/topics/john-gurney-candidate-london-draper.md` | existing_topic | 293 | clean @ c9006ce6; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `2a80a373358d…`) | `422ed5e7d72937ab0e8ce64901b7ed0ea5b911756efededd7bb452a3610fda84` |
| `research/topics/john-gurney-candidate-others.md` | existing_topic | 239 | re-frozen 2026-07-19 after the Margery/East Dereham campaign additions — assimilated to `g13-identity-candidate-b` (G13-RI-000206..000210) the same day; re-frozen 2026-08-01 (prompt-B tranche B/C: case-file v4→v5 reference swap) (prior baseline `59f8bc04f619…`) | `23f7806ffe12ae4afe743e88fa14a4f4093ca5a11d66ca414fe9f20ef506034a` |
