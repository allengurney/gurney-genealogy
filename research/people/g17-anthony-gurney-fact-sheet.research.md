...
Research companion for `g17-anthony-gurney-fact-sheet.md`. See `.claude/rules/research-files.md` for the paired-file rule.

---

## Working Notes

### Anthony on the Surrey grand jury: the *Letters and Papers* indictment text
...
Four consequences follow.<!-- discovery trail: lead L-112 -->
