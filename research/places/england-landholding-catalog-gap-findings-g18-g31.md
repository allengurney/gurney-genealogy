...
- **Online enrichment passes:** 2026-05-26/27. Searches prioritized official heritage/listing sources where available, then church, parish-history, archaeology, lost-settlement, and local-history leads.
...
## Online heritage / archaeology / church sweep — round 2 addendum

### Practical conclusion

The second online pass improved the evidence most for **Hellesdon**, **Pockthorpe**, and **Houghton St Giles**. It still did **not** identify secure surviving medieval manor-house fabric for the target Gurney/Wauncy properties. The strongest current path remains: use churches, advowsons, parish geography, and deserted-medieval-settlement records as place anchors, while keeping exact manor-house parcels unresolved unless primary archaeology/HER evidence supports them.

### Highest-value round 2 discoveries

| Place / site | Second-round discovery | Evidence value for catalog work |
|---|---|---|
| **Hellesdon — Parish Church of St Mary** | Historic England lists St Mary, Low Road, as Grade II*, List Entry 1170678, NGR TG 20053 10614. The official description records a mainly C15 church with C12 fabric in the south wall, a C15 south porch, and **brasses of Richard de Heylesdon and Ricardus Thaleburgh**.[^online-hellesdon-he] | Strongest new discovery. This directly strengthens the Heylesdon-family / Hellesdon-place narrative associated with the Alice Heylesdon inheritance stream. It is church/advowson/family-memorial evidence, not manor-house evidence. |
| **Pockthorpe — St James the Less / St James at Barr-gates** | St James the Less, Pockthorpe, is a Grade I redundant Norwich church now used by Norwich Puppet Theatre. It is first recorded in 1180 and may have replaced an earlier 11th/12th-century building; archaeological work found a clay boundary wall under the present building. The church's post-Reformation parish expanded to include Pockthorpe, and Blomefield-copied memorials included **Elizabeth Calthorp**.[^online-pockthorpe-st-james] | Strong new church/family-network anchor for G19's Pockthorpe residence through the Calthorpe kinship network. The Elizabeth Calthorp memorial is a lead to verify in Blomefield/Long/Atkin before tying to the exact Calthorpe-Gurney relationship. |
| **Houghton St Giles / Houghton in the Dale** | Historic England already gave the strongest first-pass anchor for St Giles, Grade I, List Entry 1049418. Open Domesday independently identifies **Houghton [St Giles]** in North Greenhoe Hundred with 10 households in 1086, two mills, extensive sheep pasture, and King William as tenant-in-chief.[^online-houghton-he][^online-domesday-houghton] | Strengthens the Houghton identification toward Houghton St Giles/Houghton-in-the-Dale in the Barsham cluster. Still not a manor-house-site identification. |
| **Saxthorpe — St Andrew** | Second pass found a useful St Andrew church lead: Saxthorpe's church is described as built/rebuilt in 1482 by the lord of the manor, with older chancel/tower elements and Grade I status.[^online-saxthorpe-st-andrew] | Useful but cautionary. The 1482 date falls after the 1472 Gurney/Paston/Heydon Saxthorpe court dispute and should not be interpreted as Gurney patronage without evidence. |
| **Thuxton** | A stronger archaeology lead surfaced for Thuxton: it is described as a deserted medieval linear village, with 29 tofts identified in the 1980s and East Anglian Archaeology work cited.[^online-thuxton-eaa-lead] | Useful for mapping the G18/G19 trust/appurtenant-place geography around Swathings/Hardingham. This is not a separate Gurney manor finding. |
| **Depden** | A church anchor was found: St Mary the Virgin, Depden appears in Diocese of St Edmundsbury and Ipswich parish/deanery material.[^online-depden-church-lead] | Upgrades Depden from “no church lead found” to “church anchor found but not yet heritage-listed/manor-site resolved.” Suffolk HER and direct Historic England searches remain needed. |
| **Loundhall / Saxthorpe sub-manor site** | Targeted Loundhall searches were not productive; results skewed toward unrelated Nottinghamshire Lound Hall material. | Keep Loundhall as unresolved. Do not geocode or map the Saxthorpe/Loundhall court episode to a parcel yet. |

---

## Consolidated high-priority findings after round 2
...
- **Ancestor(s):** G23 Edmund Gournay; G21 Thomas Gournay I; G19 William Gurney IV; G18 William Gurney V. Probably also G20 Thomas Gournay II by continuity.
...
- **Online heritage/current-state lead:** A lost-settlement index identifies North Barsham as a probable deserted medieval village. Treat this as a strong archaeology lead, but verify against Norfolk Historic Environment Record / Norfolk Heritage Explorer directly before assigning exact coordinates or current-site status.[^online-lost-settlements]
- **Phase 1 implication:** Add as a locality/place entry only after direct HER verification, with `currentSiteStatus` indicating a probable deserted-medieval-village lead and unresolved manor parcel.

### 2. Depden, Suffolk — Wauncy inheritance manor with advowson

- **Status:** A/H — Missing likely place entry; church anchor now found.
...
- **Online heritage/current-state lead:** St Mary the Virgin, Depden appears as a current parish/church anchor in Diocese of St Edmundsbury and Ipswich material. No secure manor-house, archaeology, or official Historic England listing was confirmed in this pass.[^online-depden-church-lead]
- **Phase 1 implication:** Add Depden as a Suffolk manor/locality candidate. Preserve the advowson detail. Follow up with Suffolk HER and direct Historic England list search before adding current-condition fields.

### 3. Denver, Norfolk — Wauncy/Gurney manor and annuity base

- **Status:** A/H — Missing likely place entry; church anchor found.
- **Ancestor(s):** G23 Edmund Gournay; G21 Thomas Gournay I; G19 William Gurney IV; G18 William Gurney V. Likely portfolio continuity through G20.
- **Catalog issue:** No Denver, Norfolk place entry was found.
- **Relationship:** Katherine de Wauncy is described in the G23 materials as associated with West Barsham, Depden, and Denver, and a 1357 grant settled 100 marks per year from West Barsham and Denver on Edmund and Katherine. G18's IPM/trust notes place Denver in the 1505 trust with West Barsham, North Barsham, and Houghton.[^g23-factsheet-wauncy][^g18-ipm-trusts]
- **Online heritage/current-state lead:** St Mary's church at Denver is identified online as physically dating from the C13 with an earlier foundation and as a listed church under Historic England List Entry 1342310. Later Denver heritage features such as Denver Sluice and Denver Mill are locality context, not medieval Gurney manor evidence.[^online-denver]
- **Phase 1 implication:** Add Denver as a locality/manor candidate and use St Mary's as a parish/church anchor with caution.

### 4. Houghton St Giles / Houghton in the Dale, Norfolk — Nerford moiety / 1505 trust property

- **Status:** A/H — Missing likely place entry; strong church and Domesday anchors found.
...
- **Online heritage/current-state lead:** Historic England lists Church of St Giles, Walsingham Road, as Grade I, List Entry 1049418, NGR TF 92372 35362; the official description records largely C14 fabric, a C14 tower, an 1877 rebuilding by William Eden Nesfield, and a Perpendicular rood screen with painted dado. Open Domesday independently identifies Houghton [St Giles] in North Greenhoe Hundred.[^online-houghton-he][^online-domesday-houghton]
- **Phase 1 implication:** Normalize the lead as `Houghton St Giles / Houghton in the Dale, Norfolk` unless primary manorial evidence proves a different Houghton. Use the church/Domesday locality as a high-confidence parish anchor, not a manor-house site.
...
- **Relationship:** The Heylesdon settlement came through Alice Heylesdon and Sir John Gurney V: manors of Hellesdon and Drayton, advowsons of both parish churches, chantries, Norwich houses, and La Selde Coronata. After Sir John's son Edmund died without issue, the inheritance crisis moved the estates to Thomas I as nephew of blood, though Alice Heylesdon later sold the bulk of the Heylesdon inheritance to Sir John Fastolf in 1433.[^g22-heylesdon-settlement][^g21-landholdings]
- **Online heritage/current-state lead:** St Margaret, Drayton appears as a surviving church anchor. Current online summaries describe the church as largely 19th century with surviving medieval features after Victorian rebuilding.[^online-drayton]
- **Phase 1 implication:** Add Drayton as a place candidate with separate manor and church/advowson context. Exact manor site remains unresolved.

### 6. Hellesdon, Norfolk — existing place, but direct-line G21 relationship likely underlinked

- **Status:** B/H — Existing place, likely under-linked; strong official church/family anchor found.
...
- **Online heritage/current-state lead:** Historic England lists Parish Church of St Mary, Low Road, Hellesdon, as Grade II*, List Entry 1170678, NGR TG 20053 10614. The official details record mainly C15 fabric, some C12 south-wall fabric, a C15 south porch, and brasses of Richard de Heylesdon and Ricardus Thaleburgh. This is directly relevant to the Heylesdon-family place narrative.[^online-hellesdon-he]
- **Phase 1 implication:** Enrich Hellesdon with church/advowson/family-memorial context, and add a direct-line G21 relationship only with a note explaining the Fastolf-sale timing and the likely technical/short-lived nature of Thomas I's possession.

### 7. Saxthorpe / Loundhall, Norfolk — existing place, but direct-line relationship underrepresented

- **Status:** B/H — Existing place, likely under-linked and under-described; church anchor found; Loundhall still unresolved.
...
- **Relationship:** DG-Supp Note 117 places Saxthorpe/Loundhall in the Gournay orbit: it was held by Rector John and later by Sir John V, and Edmund's £20/year annuity to John de Mereworthe likely reflects a settlement around the manor. G21's landholding table includes Saxthorpe/Loundhall in the inherited portfolio. G19's fact sheet preserves the 1472 manorial-court dispute involving William IV, John Paston, and Henry Heydon.[^g23-saxthorpe][^g21-landholdings][^g19-saxthorpe]
- **Online heritage/current-state lead:** St Andrew, Saxthorpe is a useful church anchor. Online summaries describe it as constructed/rebuilt in 1482 by the lord of the manor, with older chancel/tower elements and Grade I status. Because this post-dates the 1472 Gurney/Paston/Heydon dispute, it should be used as a chronological/context lead only, not as Gurney patronage evidence.[^online-saxthorpe-st-andrew]
- **Phase 1 implication:** Enrich existing Saxthorpe with direct-line narrative and a `Loundhall` alias/detail, but keep Loundhall's exact site unresolved.
...
- **Relationship:** The G27 companion and fact sheet preserve the 1264/65 plea in which John de Bolemer seized livestock and chattels on the manor of South Wootton because John de Gurney had been in the conflict of Lewes against the king and in resistance afterward. Alice de Balesham sued because the seized stock belonged to her under a twelve-year lease from John to Stephen de Balesham beginning Michaelmas 1258. Farrer independently corroborates the episode.[^g27-south-wootton][^g27-farrer]
- **Online heritage/current-state lead:** The older part of South Wootton is described as growing around the village green and St Mary the Virgin church. This supplies a village/church anchor but not a secure medieval manor-house site.[^online-south-wootton]
- **Phase 1 implication:** Add South Wootton as a strong place candidate with `parish/village anchor identified; exact medieval manor site unresolved`.

### 9. Pockthorpe-by-Norwich / The Lathes / Hassets' Hall — G19 town residence through Calthorpe kinship

- **Status:** A/C/H — Missing place entry; strong church/archaeology/family-network lead found.
...
- **Online heritage/current-state lead:** St James the Less / St James at Barr-gates is a stronger church anchor than the first-pass generic Pockthorpe lead. The church is first recorded in 1180, may replace an 11th/12th-century structure, has archaeological evidence of an early clay boundary wall, and later served an expanded parish including Pockthorpe. Blomefield-copied memorials included Elizabeth Calthorp, making this a potentially valuable Calthorpe-family church lead.[^online-pockthorpe-st-james]
- **Phase 1 implication:** Add Pockthorpe as a residence/locality lead with precision caution. Separately consider a `St James the Less, Pockthorpe` place-detail/church anchor. Do not geocode The Lathes/Hassets' Hall until stronger site evidence is found.
...
- **Online heritage/current-state lead:** St Gregory's Church survives as a Grade I redundant medieval church between Pottergate and St Benedict's Street. The church is a parish anchor, not proof of the Gurney house parcel.[^online-st-gregory]
...
- **Online heritage/current-state lead:** No secure current-state/heritage hit was found in either online pass. The correct Dunton must be disambiguated before coordinates are assigned.
...
- **Online heritage/current-state lead:** No new official source was added in the second pass beyond the existing catalog's Hingham/Gurney's Manor information. This remains an internal catalog-linking issue rather than a new heritage discovery.
...
- **Phase 1 implication:** Add only if the catalog includes trustee/feoffee places; otherwise preserve in a place-research note.
...
- **Phase 1 implication:** Treat as ecclesiastical grant/trustee context unless additional evidence shows Edmund's beneficial ownership.
...
- **Phase 1 implication:** Good candidate for future mapping of Edmund's legal network, but not a direct Gurney landholding unless more evidence is found.
...
- **Phase 1 implication:** Research lead only unless later deed analysis shows beneficial ownership.
...
- **Phase 1 implication:** Needs London Husting/Close Roll work before any exact mapping. Avoid assigning a modern parcel prematurely.
...
- **Online heritage/current-state lead:** Letton and Thuxton are flagged as deserted-medieval-settlement leads. Thuxton now has a stronger archaeology lead: a deserted medieval linear village with 29 tofts identified in the 1980s and East Anglian Archaeology work cited.[^online-lost-settlements][^online-thuxton-eaa-lead]
- **Phase 1 implication:** Distinguish manor-level entries from appurtenant-place aliases. Letton/Cranworth/Thuxton may be best handled as estate-extent details unless stronger evidence supports standalone place records.
...
- **Phase 1 implication:** Preserve as a rejected lead, not a catalog gap.
...
- **Phase 1 implication:** No place patch recommended under landholdings objective unless the site is later used for broader documentary-appearance mapping.

---

## Per-ancestor sweep notes

| Ancestor | Catalog implication after round 2 |
|---|---|
| **G18 William Gurney V** | Add/consider North Barsham, Houghton St Giles/Houghton in the Dale, Denver, Depden, Dunton if tied to William junior, and appurtenant-place aliases for the IPM/trust portfolio. |
| **G19 William Gurney IV** | Pockthorpe/The Lathes/Hassets' Hall remains important; St James the Less adds a stronger Pockthorpe/Calthorpe church anchor. Saxthorpe/Loundhall needs direct-line enrichment but Loundhall site is unresolved. |
| **G20 Thomas Gournay II** | Norwich St Gregory's parish house/tenements remain a strong place-detail candidate; Depden remains a manor/advowson candidate; East Barsham/Waldgraves remains a feoffee/seal lead. |
| **G21 Thomas Gournay I** | Hellesdon is the strongest round 2 upgrade due to the official HE listing and Heylesdon brasses. Drayton, Houghton St Giles, Depden, Saxthorpe/Loundhall, and La Selde Coronata remain candidates/leads. |
| **G22 Robert Gournay** | No direct catalog action. Heylesdon matters through his son Thomas I; Little Cressingham/Hopton remains a rejected/low-confidence namesake lead. |
| **G23 Edmund Gournay** | North Barsham, Depden, Denver, and Saxthorpe/Loundhall remain the strongest direct or inherited-place actions. |
| **G24 John de Gournay IV** | No new missing landholding. Harpley and Hardingham/Swathings already represented. |
| **G25 John de Gournay III** | No high-confidence new direct landholding. Bardolf feoffee evidence remains likely collateral Rector John. |
| **G26 Sir William de Gournay III** | No new missing landholding. 1274 Hardingham warren claim should enrich the Hardingham narrative. |
| **G27 Sir John de Gournay I** | South Wootton remains the key missing direct manor. Hingham/Gurney's Manor early links need reconciliation. |
| **G28 William de Gournay II** | No new direct landholding. Dore Abbey remains a documentary-appearance lead only. |
| **G29 Matthew de Gournay** | No new missing landholding. Harpley marriage-acquisition narrative remains important. |
| **G30 William de Gournay I** | Swathings/Hardingham extent across Hardingham, Letton, and Cranworth remains important; Thuxton appurtenant archaeology lead may help estate-extent mapping. |
| **G31 Walter de Gournay** | Early Hingham Gurney's and Swathings branch-foundation links remain underlink/reconciliation issues. |

---

## Suggested Phase 1 intake order after round 2
...
2. **Existing-place corrections/enrichments:** Hellesdon G21/Heylesdon-family link; Saxthorpe/Loundhall direct-line links; Hingham/Gurney's Manor early-generation links; Hardingham/Swathings extent details for Letton/Cranworth/Thuxton.
3. **Church/heritage anchors to research before geocoding:** St Mary Hellesdon; St James the Less Pockthorpe; St Giles Houghton; St Mary Denver; St Margaret Drayton; St Andrew Saxthorpe; St Mary South Wootton; St Gregory Norwich; North Barsham DMV; Pockthorpe DMV; Thuxton DMV.
...
5. **Hold/reject unless new evidence appears:** Little Cressingham/Hopton Robert Gurnay; Bardolf feoffee properties for uncertain John de Gurnay; Dore Abbey; exact Loundhall site pending better evidence.
...
[^online-hellesdon-he]: Online heritage sweep, round 2, 2026-05-27. Historic England, National Heritage List for England, "Parish Church of St Mary," Low Road, Hellesdon, Grade II*, List Entry 1170678, NGR TG 20053 10614. Official details record mainly C15 fabric, C12 fabric in the south wall, C15 south porch, and brasses of Richard de Heylesdon and Ricardus Thaleburgh. URL: https://historicengland.org.uk/listing/the-list/list-entry/1170678

[^online-pockthorpe-st-james]: Online heritage sweep, round 2, 2026-05-27. St James the Less, Pockthorpe / St James at Barr-gates summary: redundant Grade I Norwich church, first recorded 1180, possible 11th/12th-century predecessor, clay boundary wall under foundations, current Norwich Puppet Theatre use, and Blomefield-copied memorials including Elizabeth Calthorp. URL checked as lead: https://en.wikipedia.org/wiki/St_James_the_Less,_Pockthorpe. Verify in Blomefield, Long, Atkin, Norwich Historic Churches Trust, and/or Norfolk Record Office before final catalog use.

[^online-houghton-he]: Online heritage sweep, first pass, 2026-05-26/27. Historic England, National Heritage List for England, "Church of St Giles," Walsingham Road, Barsham / Houghton St Giles, Grade I, List Entry 1049418, NGR TF 92372 35362. Official description: parish church, largely C14 fabric rebuilt 1877 by William Eden Nesfield, C14 tower, Perpendicular rood screen with painted dado. URL: https://historicengland.org.uk/listing/the-list/list-entry/1049418

[^online-domesday-houghton]: Online heritage sweep, round 2, 2026-05-27. Open Domesday, "Houghton [St Giles]," North Greenhoe Hundred, Norfolk: 10 households in 1086, King William as tenant-in-chief/lord, two mills, meadow, and pasture resources. URL: https://opendomesday.org/place/TF9235/houghton-st-giles/

[^online-saxthorpe-st-andrew]: Online heritage sweep, round 2, 2026-05-27. Saxthorpe locality/church summary: St Andrew described as constructed in 1482 by the lord of the manor, with older chancel/tower elements and Grade I status. URL checked as lead: https://en.wikipedia.org/wiki/Saxthorpe. Verify against Historic England/Norfolk Churches before final catalog wording.

[^online-thuxton-eaa-lead]: Online heritage sweep, round 2, 2026-05-27. Thuxton summary citing East Anglian Archaeology 1989, Lawrence Butler and Peter Wade-Martins, "The Deserted Medieval Village of Thuxton, Norfolk," and describing a deserted medieval linear village with 29 tofts located in the 1980s. URL checked as lead: https://en.wikipedia.org/wiki/Thuxton. Verify against the East Anglian Archaeology report/NHER before final catalog use.

[^online-depden-church-lead]: Online heritage sweep, round 2, 2026-05-27. Diocese of St Edmundsbury and Ipswich parish/deanery material identifies St Mary the Virgin, Depden within the Chevington/Depden/Rede/Hawkedon grouping. URL checked as lead: https://en.wikipedia.org/wiki/Diocese_of_St_Edmundsbury_and_Ipswich. Verify against parish, Suffolk HER, and Historic England.

[^online-lost-settlements]: Online heritage sweep, first pass, 2026-05-26/27. "List of lost settlements in Norfolk" identifies North Barsham as a probable deserted medieval village, Pockthorpe as a deserted medieval settlement site, and flags Letton and Thuxton as deserted-medieval-settlement leads. URL checked as lead: https://en.wikipedia.org/wiki/List_of_lost_settlements_in_Norfolk. Treat as an index to verify against Norfolk Historic Environment Record / Norfolk Heritage Explorer, not as final authority.

[^online-denver]: Online heritage sweep, first pass, 2026-05-26/27. Denver locality summary identifies St Mary's church as C13 with an earlier foundation and cites Historic England List Entry 1342310; the same page cites later Denver heritage features including Denver Sluice and Denver Mill. URL checked as lead: https://en.wikipedia.org/wiki/Denver,_Norfolk. Direct Historic England page should be verified during Phase 1 before copying list detail into catalog fields.

[^online-drayton]: Online heritage sweep, round 2, 2026-05-27. Drayton locality summary identifies St Margaret's Church as a surviving church with some medieval features after later rebuilding. URL checked as lead: https://en.wikipedia.org/wiki/Drayton,_Norfolk. Verify against Historic England/Norfolk Churches before final catalog wording.

[^online-south-wootton]: Online heritage sweep, first pass and round 2, 2026-05-26/27. South Wootton locality summary places the village about two miles northeast of King's Lynn and notes that the older part of the village grew around the green and St Mary the Virgin church. URL checked as lead: https://en.wikipedia.org/wiki/South_Wootton. This is a parish/village anchor only, not a medieval manor-house identification.

[^online-st-gregory]: Online heritage sweep, first pass, 2026-05-26/27. St Gregory's Church, Norwich summary identifies the church as a Grade I redundant medieval church between Pottergate and St Benedict's Street. URL checked as lead: https://en.wikipedia.org/wiki/St_Gregory%27s_Church,_Norwich. Verify against Historic England/Norwich Historic Churches Trust before precise catalog fields.
