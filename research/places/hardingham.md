...
### Swathings held of Bardolf "as parcel of the barony of Gurnay" (Thomas Bardolf IPM, 1329)

The inquisition post mortem of Thomas Bardolf, taken 1329 and calendared as no. 243 of the *Calendar of Inquisitions Post Mortem*, vol. 7, is the primary printed-calendar record that ties the junior line's Swathings tenure to the old senior Gournay barony. Within the same extent that returns Bardolf's Norfolk caput manors, the manor of "Shathingge" (Swathings) is returned as "held by John de Gurnay by service of a knight's fee" — the junior-line John holding Swathings *of* Bardolf.[^cipm-bardolf-swathings]

The surrounding extent items show why that matters. Bardolf's manors of Caister by Great Yarmouth, Cantley, and Winburgh were re-settled on Thomas Bardolf and Agnes his wife in 7 Edward II (1313/14), by a fine levied through the feoffees "John de Gurnay and John de Halughton," and are returned as held in chief "as parcel of the barony of Gurnay." That barony is the forfeited senior-line Gournay honour, which had descended to the Bardolfs through Juliana de Gournay (heir of the last senior-line Hugh, wife of William Bardolf of Wormegay). So the junior John de Gurnay appears here twice over: as the trusted feoffee who re-settled the Bardolfs' Gournay-barony manors in 1313/14, and as tenant of Swathings held of Bardolf by knight service.[^cipm-bardolf-swathings]

This is the primary-calendar confirmation of the tenure chain that Daniel Gurney's Supplement (Note 115) had recorded only from a later Norfolk feodary ("Johannes Gurney tenet manerium de Swathyng in Hardyngham de Hugone de Bardolf et idem de Rege") and from the Escheat Rolls of 7 Edward II. The earlier vol.-5 (Edward II) calendar check that failed to surface it did so because the record sits in vol. 7 (Edward III), inside the Bardolf IPM. It squares the "divided vill" reading of Swathings on this file with a fixed datum: by 1313/14 the junior John holds Swathings of the Bardolfs as the senior line's heirs, not of the Crown directly. Which John — the collateral Rector John (d. 1332) or the direct-line G25 John III — the calendar does not say; that attribution stays open.[^cipm-bardolf-swathings][^dg-supp-note115-xref]

[^cipm-bardolf-swathings]: "Inquisitions Post Mortem, Edward III, [no. 243, Thomas Bardolf]," *Calendar of Inquisitions Post Mortem*, vol. 7, pp. 174-183 (volume index pp. 571-576: "Gurney ... John de, 243 (pp. 176, 180)"; "Gurney, Gurnay, barony, 243 (p. 176)"), British History Online, https://www.british-history.ac.uk/inquis-post-mortem/vol7/pp174-183. Verbatim extract of the Swathings, Caister, Cantley, and Winburgh extents at `sources/corpus_supplement/bho-ipm-edward-iii-vol7-243-bardolf-swathings.md`. Source ID: `bho-ipm-edward-iii-vol7-bardolf-swathings`.
[^dg-supp-note115-xref]: Cross-reference, not a source: the feodary and Escheat-Roll versions of the same tenure are worked up on the G25 companion, `research/people/g25-john-de-gournay-iii-fact-sheet.research.md`, from Daniel Gurney, *Supplement to the Record of the House of Gournay* (1858), Note 115, pp. 787-788.

### Hugh de Gurnay of Letton (Ancient Deeds A.2972)

Daniel Gurney's own reading that "the manor of Swathings … consisted of part of Hardingham, Letton, and Cranworth" gains a 12th–13th-century Letton datapoint in the person of a Hugh de Gurnay styled "of Letton." By the undated deed A.2972 he granted the monks of Lewes (St Pancras) in frank almoin the tenement Matilda daughter of Aliz held of him in Letton — 18d. yearly from land part on Wrongelond, part in Sudfeld, part in Humelescroft, and part on "Cranewrdefeld" (Cranworth field); Blomefield's Letton entry records the same gift "sans date." A senior-line forename (Hugh) operating in this junior-line Mitford-hundred corner, in the Warenne-priory orbit, is a datapoint for the cadet-enfeoffment question rather than a resolved descent — the fuller treatment sits in the collateral topic file.[^letton-a2972][^letton-a2972-xref]

[^letton-a2972]: *A Descriptive Catalogue of Ancient Deeds in the Public Record Office*, vol. 2, A.2972 (Norfolk deeds, pp. 132-144), British History Online, https://www.british-history.ac.uk/descriptive-cat-ancient-deeds/vol2/pp132-144; with Francis Blomefield, *Topographical History of Norfolk*, vol. 10, pp. 231-233 (Letton, Lewes Priory Manor). Verbatim abstract at `sources/corpus_supplement/ancient-deeds-a2972-hugh-gurnay-letton.md`. Source IDs: `descriptive-catalogue-ancient-deeds`, `blomefield-norfolk`.
[^letton-a2972-xref]: Cross-reference, not a source: the cadet-enfeoffment synthesis this datapoint feeds is in `research/topics/anderson-yvery-harpetre-gournay-collateral.md`.
