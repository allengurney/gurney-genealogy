...
- `confidence`: Medium
- Source / citation status: no formal citation preserved in source JSON; inherited note retained verbatim
- Inherited note / quote: Commercial premises, Manhattan (Gurney & Underhill wholesale firm) — 54 Hudson Street, Manhattan, NY
