...
- `placeId`: `place-sigy-saint-martin-priory-normandy-france`
- Short description: La Ferté cadet-line priory and church site
- Place type: abbey / priory / church
- Aliases: Sigy, Sigi, Sigy-en-Bray, Abbaye Saint-Martin, Église abbatiale Saint-Martin, Priory of Sigy, Saint-Martin de Sigy, Saint-Vulgain
- Coordinate: 49.547222, 1.491389 (medium)
- Roles: ecclesiastical site, cadet-line landholding context, charter / reversion context
- Site name: Abbaye Saint-Martin / Église abbatiale Saint-Martin
- Street address: Rue de l'Abbaye, 76780 Sigy-en-Bray
- Detail: Early La Ferté / Gournay cadet-line ecclesiastical site. Pettigrew and later summaries place Sigy near La Ferté and tie its foundation to Hugues de La Ferté; Normandy Abbeys describes the abbey's history as closely tied to the lords of La Ferté, descendants of the Gournay family.
- Current-site status: extant former abbey church / parish church - The former abbey church survives as a parish church and Monument Historique. Normandie Tourisme describes the visible building as a fine 13th-century former abbey church with early Gothic choir and seven-sided apse. Normandy Abbeys says the first church was probably burned in the 12th century and has not been preserved, while the local tourism office / MonVillageNormand states that the nave survives from the early abbey phase. Treat early-fabric survival as uncertain unless a stronger architectural source resolves the conflict.
- Coordinate basis: modern commune / church-locality coordinate; refine to exact church coordinate if found
- Links: [Normandie Tourisme: Abbaye Saint-Martin](https://www.normandie-tourisme.fr/sites-lieux-de-visites/abbaye-saint-martin/)
...
- Research narrative already exists but lacks canonical JSON record.
- Use for La Ferté cadet-line ecclesiastical history and reversion logic.
- Do not collapse into La Ferté-en-Bray; Sigy is a separate place.
