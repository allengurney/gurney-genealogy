...
- Named sub-sites: 55 Pike Street

### Registry entries

#### G6 Brigadier General William Gurney — address reference

- `locationId`: `loc-185d47ebfd71`
- `recordId`: `ancestor-g6-brigadier-general-william-gurney`
- `eventDate`: 1821–1879
- `siteName`: 55 Pike Street
- `region`: New York, USA
- `coordinates`: 40.712, -73.9903
...
- Inherited note / quote: 55 Pike Street, Manhattan, NY
