...
- Detail: An open-field division of early Weymouth in which John Gurney Sr. (G13) held a two-acre grant recorded in Nash's 1643 property list as "first granted to John Gurny," by then held by Robert Randoll (of Wendover, Bucks). Its lots are bounded in the records "with the sea," the Back River, and "a greate pond" (Whitman's Pond), placing the field in the original North/East Weymouth settlement toward the water.
