# Gournay Norman holdings overlay v5 source register

This register supports `research/geo/gournay_norman_holdings_recommended_overlay_v5_source_informed.geojson`.

## Highest-authority / controlling sources

| Source | URL | Overlay use |
|---|---|---|
| Projet ConDE 24-village text | https://pdn-lingua.unicaen.fr/coutumiers/conde/pesnelle_lighter.xml/pesnelle-lighter-beta-002-007.html | Controlling source for Conquets Hue de Gournay list and customary-law framing |
| Ferrieres-en-Bray official history | https://www.ferrieres-en-bray.fr/page/la-commune/l-histoire-de-ferrieres/histoire-de-la-ville | Confirms Ferrieres, Le Foret, Hardencourt, and Laudencourt in the Conquets of Hugues de Gournay |
| Gancourt-Saint-Etienne municipal bulletin | https://gancourtsaintetienne.com/wp-content/uploads/2023/12/bm2023-1.pdf | Confirms Gancourt among the twenty-four conquests and under high justice of Gournay |
| Gaillefontaine official history | https://www.mairiegaillefontaine.fr/pages/decouvrir-et-bouger/histoire/historique.html | Supports Gaillefontaine fortress tradition, motte survival, and Gournay / La Ferte connection |
...
| Source | URL | Overlay use |
|---|---|---|
| Ferrieres-en-Bray tourism page | https://tourismedes4rivieresenbray.com/ferrieres-en-bray/ | Corroborates Hugues de Gournay and Ferrieres in the 24-village context |
