...
<tr class="status-probable">
  ...
  <td>Unknown</td>
  <td><span class="badge-probable">PROBABLE (~65%)</span></td>
...
<tr>
  ...
  <td>Unknown</td>
  <td><span class="badge-eliminated">ELIMINATED</span></td>
  <td>Continuing London presence: 1638 T.C. Dale return at GBP10 rent and 1662 hearth tax at 1 hearth "poore" at the same St Augustine precinct.<sup class="fn"><a href="#n92a" id="ref-92a">92</a></sup> <sup class="fn"><a href="#n110" id="ref-110">110</a></sup></td>
</tr>
<tr class="status-unlikely">
  <td>Aylesbury, Bucks (John + Anne Cowheard)</td>
  <td>Buckinghamshire</td>
  <td><strong>Anne</strong> Cowheard</td>
  <td><span class="badge-unlikely">Unlikely (~1%)</span></td>
  <td>Single indexed event: marriage 1638 at Saint Mary, Aylesbury; no continuation of household indexed and no emigration evidence. A 1638 bride named Anne is structurally incompatible with the colonial John, whose wife Mary was married by c.1627 and lived to 1661.<sup class="fn"><a href="#n105" id="ref-105">105</a></sup></td>
</tr>
<tr class="status-unlikely">
  ...
  <td><span class="badge-unlikely">Unlikely (~1%)</span></td>
  <td>Marriage 7 February 1638 Amersham; single indexed event; no continuation of this couple's household and no emigration evidence. Same structural incompatibility as the Cowheard row: a 1638 bride who is not Mary.<sup class="fn"><a href="#n94" id="ref-94p">94</a></sup></td>
</tr>
<tr class="status-unlikely">
  ...
  <td>Single indexed event: Mary Gurny bapt 1631 at Hitcham, father John Gurny; mother and siblings unindexed; no further Hitcham Gurney activity surfaces 1620–1665.<sup class="fn"><a href="#n88" id="ref-88d">88</a></sup> <sup class="fn"><a href="#n107" id="ref-107">107</a></sup></td>
</tr>
<tr class="status-unlikely">
  ...
  <td><span class="badge-unlikely">Unlikely (~1%)</span></td>
  <td>Single indexed event: marriage 1639 at Saint Benedict, Norwich; no continuation of a John + Jane Norwich household and no emigration evidence indexed. A 1639 bride named Jane is structurally incompatible with the colonial John's wife Mary (married by c.1627, died 1661).<sup class="fn"><a href="#n104" id="ref-104">104</a></sup></td>
</tr>
<tr class="status-unlikely">
  ...
  <td>John Gurnoe + Mary Burton m. Ackworth 6 June 1636; son John Thomas bapt Ackworth 1637; no further indexed Yorkshire activity. The only same-name household with a wife named Mary and an emigrant-shaped disappearance — but held at Unlikely because the colonial John's marriage to Mary is bounded before 1628 (see §6.1), so the 1636 bride fits only as a hypothetical second wife, and a 1637 son christened John Thomas collides with the colonial son John Jr. (b. c.1633). Yorkshire also sits outside the East Anglian corridor.<sup class="fn"><a href="#n93" id="ref-93a">93</a></sup> <sup class="fn"><a href="#n106" id="ref-106">106</a></sup></td>
</tr>
</tbody>
</table>
...
| 3 | Occupation: Merchant Taylor father -> tailor son | Moderate-strong | Trades commonly passed from father to son, but not always through formal admission: the Merchant Taylors' books 1583-1800 show no John son of Francis bound or freed, and the Norwich freemen and enrolled-apprentice registers show no John Gurney in the window (see Against row 9) — so if Candidate B holds, John trained under a country master or inside the household. The colonial half of the match stands at registry level: John's own 1661/2 conveyance styles him "John Gurney of Braintry Taylor in new England" in the Suffolk registry copy.<sup class="fn"><a href="#n72" id="ref-72b">72</a></sup> Of the named candidates only Candidate D shares a textile-trade link, and D's continuing London residence to 1662 rules him out as the colonial John (see Section 8.4). |
...
| # | Evidence | Weight | Explanation |
|---|----------|--------|--------|
| 1 | Entry E's c.1609/10 date predates the 1653 deposition's "aged about 50" by 6-8 years | Moderate-strong negative | Wilson v. Faxon (1653) places the colonial John's birth at c.1602/3 (deponent "aged about 50 years"). Entry E reads as a c.1609/10 baptism. If both are correct as written, the East Dereham baby is roughly seven years too young to be the colonial John - surviving the "about 50" testimony only under a wide age-rounding reading and/or a deponent age exaggeration/boasting. The early edge of Entry E's ±2-year window (c.1607) narrows the gap to four or five years and simultaneously eases a second strain running the same direction: John married Mary by c.1627, a husband at seventeen or eighteen on the c.1609/10 reading — young for an English bridegroom of the period — but a more typical twenty on the c.1607 reading.<sup class="fn"><a href="#n45" id="ref-45b">45</a></sup> The two tensions resolve together at the early edge of the window. |
...
|---|---|---|
| **B — Son of Francis & Margaret Rybett** | **~65%** | Margaret Rybett 1611 Norwich marriage primary; tailor-from-Merchant-Taylor trade lineage; Norfolk + London corridor (Fischer ~60% MA Bay from 9 eastern counties); Essex colonial associations (Daniel Shed, Tyng leasehold, Coleman Street adjacency); Ann Gurney / Gilman Norfolk-Hingham → MA-Hingham 1638 corridor; Francis Gurney's East Dereham child cluster reinforced by confirmed burial entries for Marye and Agnes and a probable 1633 burial for a younger Francis; Mary Shed's 1647 Braintree marriage bounds Mary Gurney's English birth before 1628; Entry E paleographic reading favors "ffrancis Gurnie"; and the Newgate/Horningsheath finding redirects Banks's Bury St Edmunds attribution off the elder Braintree John (raised from ~60% in v4.2 on these last three developments). Principal offsets holding the estimate down are listed below the table.<sup class="fn"><a href="#n101" id="ref-101a">101</a></sup> |
...
| **D — Son of Robert Gurney, draper of Old Change** | **ELIMINATED** | John Gurney documented at St Augustine Watling Street at GBP10 rent in 1638 (T.C. Dale) and at 1 hearth "poore" in 1662, the same year the colonial John was dying in the colonies. See Section 8.4. |
| **Other named candidates (Unlikely)** | **~8% combined** | Ackworth Mary Burton 1636-1637 (~3% — the only wife-name match, capped by the pre-1628 marriage bound and the John Thomas naming collision); Hitcham 1631 (~2% — single event, household profile unknown); the single-attestation 1638-39 grooms at Aylesbury (Cowheard), Amersham (Garter), and Norwich (Wright) (~1% each — each marries a bride who is not Mary after the colonial John's marriage window closed). |
| **Unknown corridor (East Anglia / London)** | **~18%** | Residual for an undiscovered candidate in the dominant emigration corridor. The London Gurney 1662-1666 hearth-tax cluster (eleven Gurney/Gurny households across the City, Westminster, and inner Middlesex) documents a denser London-area Gurney environment than previously surfaced, keeping this residual material. |
| **Unknown other corridor (Kent, Lincs, West Country)** | **~9%** | Wildcard-level marriage sweeps (see §6.1) have not surfaced any out-of-corridor John + Mary household beyond the eliminated Eythorne event, trimming this residual slightly. |

The estimates sum to 100 percent and answer one question: who was the John Gurney who died at Braintree in 1662/3. Two reading notes. First, **the ~65% for Candidate B is read against its offsets**, not just its support: the six-to-eight-year tension between Entry E and the 1653 deposition; the absence of a son named Francis; the missing English marriage record; and the negative searches of both formal trade-admission registers (Merchant Taylors' 1583-1800 and the Norwich freemen and enrolled-apprentice registers — see §10.1). Those four offsets are why the estimate is not higher. Second, **the 1636 Newgate apprentice no longer appears in this table**: §8.5 eliminates him as the colonial John on family-status and chronology grounds, so the question he carries — whether Banks's Bury St Edmunds memo tracked him rather than the Braintree man — is a sourcing question about Banks, not a residual identity scenario.
...
<ol class="endnotes">
  ...
  <li id="n101" value="101">The ~65% point estimate for Candidate B reflects the combined weight of the supporting evidence in §10.1 against the offsetting concerns in §10.1. The estimate was raised from ~60% (v4.2) on three developments: the Newgate/Horningsheath finding redirecting Banks's Bury St Edmunds attribution off the elder Braintree John (§8.5); primary-index confirmation of Francis G14's East Dereham child cluster (Marye and Agnes burials, probable 1633 Francis burial); and the Mary Shed 1647 marriage bounding the John + Mary marriage to England before 1628, which reframes the missing-marriage negative as a parish-coverage gap. Partly offsetting the raise, the formal trade-admission negatives (Merchant Taylors' 1583-1800; Norwich freemen and enrolled-apprentice registers) remove the cleanest documentary pathway for the tailor-from-Merchant-Taylor trade match. Supporting weight: the primary-record-confirmed Margaret Rybett marriage at Norwich in 1611 (NRO PD 12/1, fitting the chronological window for a son born c.1609/10); a tailor-from-Merchant-Taylor trade match consistent with the 17th-century pattern of sons following father into the same trade; placement in the dominant East Anglia → London emigration corridor that produced roughly sixty percent of Massachusetts Bay emigrants in the 1630s; a documented financial motive (the 1634 Court of Wards land sale liquidating Francis's Norfolk and Suffolk holdings); a substantial Essex colonial network on John's Massachusetts side (Daniel Shed of Finchingfield as son-in-law, the William Tyng leasehold in Braintree, the Braintree-Massachusetts/Braintree-Essex name carry-over, Coleman Street parish adjacency to Francis's St Benet Fink); the Ann Gurney / Gilman Norfolk-Hingham → Massachusetts-Hingham emigration corridor; Francis G14's East Dereham child cluster reinforced by primary-record-confirmed burials for Marye and Agnes and a probable 1633 burial for a younger Francis; and Mary Shed's 1647 Braintree marriage bounding her English birth before 1628. Offsetting concerns: the age mismatch between Entry E (c.1609/10) and the 1653 deposition's "aged about 50" (implying birth c.1602/3) — 6 to 8 years that survive only under a wide reading of "about"; the absence of a son named Francis in the colonial John's family — the strongest single naming-pattern concern; the absence of any indexed John+Mary marriage in eastern-England parish-marriage collections 1620-1635 outside the eliminated Eythorne Kent / Mary Marsh event; and common-name density across English parishes 1600-1670, with parish-coverage gaps leaving room for unidentified candidates in the corridor. The 65% estimate is a working summary, not a calculated probability — it is rounded to the nearest 5% and should be read with that precision. <a class="backref" href="#ref-101a">↩</a></li>
