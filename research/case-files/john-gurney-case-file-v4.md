...
1. **TAG 10:70–73** — likely source of Anderson's 1636 arrival date; highest-priority scholarly source to pull.
2. **SPR Case #338** — John's probate file; may name children and solidify the John → Richard relationship.
3. **The 1653 deposition** (Wilson v. Faxon) — full case context may include origin details.
4. **St Stephen Coleman Street parish registers** — full Gurney search 1600–1660.
5. **Berkhamsted marriage registers** — John Gurney to Mary would elevate Candidate C.
