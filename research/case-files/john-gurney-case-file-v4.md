...
| 3 | Occupation: Merchant Taylor father -> tailor son | Moderate-strong | Trades commonly passed from father to son, but not always through formal admission: the Merchant Taylors' books 1583-1800 show no John son of Francis bound or freed, and the Norwich freemen and enrolled-apprentice registers show no John Gurney in the window (see Against row 9) — so if Candidate B holds, John trained under a country master or inside the household. Of the named candidates only Candidate D shares a textile-trade link, and D's continuing London residence to 1662 rules him out as the colonial John (see Section 8.4). |
