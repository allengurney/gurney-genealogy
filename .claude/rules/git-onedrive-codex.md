...
The repo layout, OneDrive split rationale, and "why git internals stay outside OneDrive" are in `AGENTS.md` §9 (Local environment).
...
- Unless directed otherwise, use `main` for all work; create a branch only if asked.
...
## See also
- `AGENTS.md` §9 (Local environment — OneDrive + git layout) — the durable repo layout
