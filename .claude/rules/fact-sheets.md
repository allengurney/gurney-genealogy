...
- Highly technical, genealogical, or historical terms which are not in common modern usage should either be a hyperlink to a definition or explanatory source (e.g. wikipedia.org), explained in the prose, a parenthetical synonym, or otherwise avoided for plain English consumption. Examples: "feoffee," "advowsons," "engrailed," "impaling," "in right of his wife," "moiety," "first attested." Give period date-anchors as plain years or spans ("held since 1086," not "since Domesday Book"; "early January," not "34 Edw. III").
