...
def main() -> None:
    ...
    data = {
        ...
        "metadata": {
            ...
            "not_cadastral": True,
            "initial_display_policy": "All major groups are visible for visual review; later institutional and southern boundary-control layers are marked future_default_after_review=false.",
