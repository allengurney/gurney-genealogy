...
def main() -> None:
    ...
    overlay_place_anchors = [
        ...
        (
            "anchor_beaubec_la_rosiere_institutional",
            "Beaubec-la-Rosière",
            "later_gournay_institutional",
            [1.55, 49.62],
            "medium-low",
            "later Gournay institutional geography",
            "Beaubec-la-Rosière is associated with a later Gournay institutional foundation, but should remain a later/collateral context anchor.",
            "Do not merge into direct G30-G37 holdings or the Conquets polygon.",
