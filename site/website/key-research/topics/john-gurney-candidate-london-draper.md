---
title: "John Gurney Candidate — London Draper / Old Change (D)"
description: "Working research notes on the John Gurney Candidate — London Draper / Old Change (D) analysis for John Gurney of Braintree, Massachusetts (G13) in the Gurney genealogy library: source-by-source alternative-candidate evidence, comparisons, and open questions."
permalink: /key-research/topics/john-gurney-candidate-london-draper.html
...
An earlier London Gurney/Gournay mercantile comparator now sits just before Robert's documented Old Change career. The 1567-1568 London port book indexes Richard Gurney as a haberdasher and points to twelve entries; the selected May-July 1568 extracts show Richard repeatedly importing Danzig/Baltic flax, with additional Spanish iron and eels in the sample.[^richard-port-book] Alfred P. Beaven's aldermen list then identifies Richard Gourney, Haberdasher, as alderman for Portsoken and Bridge wards, Sheriff in 1589-1590, Auditor in 1587-1589, and Master of the Haberdashers' Company in 1589-1590 and 1596-1597; he died 5 March 1597, with PCC will 35 Cobham dated 15 October 1596 and proved 8 April 1597.[^beaven-richard-gourney] The port-book haberdasher and alderman are a strong working correlation, but neither record identifies Richard as kin to Robert Gourney or to the later Haberdashers' Gournay charity.
...
The 11 February 1623/4 Drapers' freedom event (DREW5638) is a single integrated transaction recording John Gurney as new freeman by redemption and Robert Gurney as father of freeman. Neither party has an occupation or location stated in the event record.[^rollco-drapers-1624]
...
[^rollco-drapers-1624]: ROLLCO Drapers' Company [event DREW5638](https://www.londonroll.org/event/?company=drp&event_id=DREW5638), freedom by redemption, 11 February 1623/4, new freeman John Gurney, father of freeman Robert Gurney. Source ID: `rollco-drapers-gurney-old-change-cluster`.
[^richard-port-book]: Brian Dietz, ed., *The Port and Trade of Early Elizabethan London: Documents*, London Record Society, vol. 8 (London, 1972), British History Online, index entry for "Gurney, Richard, haberdasher" and selected London Port Book 1567-8 entries 557, 563, 564, 583, 593, and 617, accessed 2026-05-25; Source ID: `bho-port-trade-early-elizabethan-london-richard-gurney-1567-8`.
[^beaven-richard-gourney]: Alfred P. Beaven, ["Chronological list of aldermen: 1501-1600,"](https://www.british-history.ac.uk/no-series/london-aldermen/hen3-1912/pp20-47) in *The Aldermen of the City of London Temp. Henry III - 1912* (London, 1908), British History Online, Richard Gourney, Haberdasher, 16 January 1589 entry, accessed 2026-05-25; Source ID: `bho-beaven-aldermen-richard-gourney-1589-1597`.
[^rollco-1581]: ROLLCO Drapers' Company [event DREW4826](https://www.londonroll.org/event/?company=drp&event_id=DREW4826), freedom by servitude, 16 December 1581, new freeman Robert Gourney "Tailor, Old Change", master Robert Furnes. Source ID: `rollco-drapers-gurney-old-change-cluster`.
