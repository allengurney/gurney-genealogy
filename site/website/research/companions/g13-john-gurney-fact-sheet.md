...
Pre-fact-sheet. No published narrative yet. Active research lives in this file. It is currently paired with [`research/case-files/john-gurney-case-file-v4.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v4.md) and may later migrate to `research/case-files/candidate-b.md` if the case-file structure is reorganized.
