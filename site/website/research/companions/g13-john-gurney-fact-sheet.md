...
### 2026-06-09 session — Norwich corporate registers, wildcard marriage sweep, case-file v4.3 sync
...
**Case file v4.3 probability sync.** Candidate B raised to ~65% in case file §11 (matching this file's Working Hypotheses, trimmed from the earlier 65–70 band by the formal trade-admission negatives above); the 1636 Newgate apprentice removed from the identity distribution (he is eliminated as the colonial John, so the Banks-memo question is a sourcing question, not an identity scenario); Ackworth raised to ~3% on the Mary-wife match and emigrant-shaped disappearance, capped by the pre-1628 marriage bound; the non-Mary single-event 1638–39 grooms cut to ~1% each.

**FamilySearch Full-Text Search campaign — first pass run ("John Gurney," 1600s document bucket, 134 results, both pages walked).** The un-indexed-text modality produced colonial primary upgrades and new English leads in one pass.[^fts-campaign-2026-06]
...
- **Costessey, Norfolk, manorial records 1633–1635: a probable John Gurney land entry in the 1634 court roll — image located, paleography pending.** The page is a Latin court-roll entry headed 1634 (FamilySearch film 004389191 item 4, image 162 of 239, ark:/61903/3:1:S3HT-6PN9-SW7); the flagged line plausibly reads "…terra Joh[ann]is Gurny…" at screen resolution, but the hand needs a full-resolution paleographic read before the surname is treated as confirmed. Costessey is the laceweaver Francis B's documented property locus (AGENTS §6 standing fact #4), so a confirmed John Gurney landholding there in 1634 — in-window, in-corridor — would be either kin of Francis B or a previously unknown Norwich-area John. Highest-priority English verification from this pass.
...
**Second pass (variant forms and children-name anchors), same day.** The children-name angle works through documents rather than parish registers — full-text coverage is wills, court books, town books, and manor rolls — so the rare names Peter and Isaac were run as anchors alongside John-form and Gurney-form variants:
...
**Third pass (Latin forms, remaining spellings, Dereham probe), same day.**
...
**Fifth pass — the earlier roll (film 004389483: East Dereham Court Records 1623–1689, bundled with Deopham and Denver), 9 result cards, all reviewed.** The copyhold chain extends back two decades further: **Margaret/Margery Gurney's land appears in entries dated 1662 and 1665** ("land [of] my Margaret Gurney was proved…"; "Margery Gurney or abutt…"), her abuttal recitals run through 1680–1694, and one entry dated **1640** carries a Gurney token (machine-read "…in Lewes Withes Gurney and interest as Wagstaffe…" — badly garbled Latin; the image may name a male holder). The remaining hits are the 19th-century Gurney & Co bank (Samuel Gurney Buxton, Francis Hay Gurney, "Messieurs Gurney and Co," 1860s–80s) in the Denver portion of the film — not the local family. The succession now reads: **[1640 entry, holder unread] → Margaret/Margery Gurney (1662–1694) → Michael Gurney (1697–1758) → Richard Gurney (1703, recited to 1837)**. A widow holding her late husband's copyhold by free bench is the classic pattern behind a long female tenure like Margery's — and **Edward Gurney (b. c.1610/11, John's full brother) would be exactly the right age to be the husband who died by c.1662**. Image-read targets, in order: the 1640 entry; the 1662/1665 Margaret entries; and Michael's 1697 admission (which should recite his predecessor).[^dereham-early-roll-2026-06]
...
Remaining campaign passes: image reads of the 1640, 1662/1665, and 1697 East Dereham entries (L-98); "Jno Gurney"; Norfolk place-filtered sweeps if the filter UI cooperates.
...
### 2026-05-29 online-research session — lead dispositions (L-4, L-7, L-8, L-9, L-12, L-17, L-18, L-19)

A pass through the high-priority, online-accessible G13-origin leads. The durable products are the two transcribed Rattlesden wills (L-7), the reconciled St Benet Fink child-list (L-9), and a new Full-Text corroboration of Francis of Maldon (L-8, recorded on his own file).
...
### 2026-05-29 (round 2) — L-5 Spelman pedigree and L-6 Norwich wills (availability)
...
|---|---|---|
| Birth c. 1607–12, early edge favored | AGENTS.md §6 #6 (revised from c. 1603 after Francis + Margaret marriage confirmation; deposition and c.1627 marriage favor the early edge) | Inferred from family chronology |
...
10. **Millican freemen register, page-level pull.** Pp. 173 and 199 (the two HathiTrust Gurney-variant hits) plus the ff. ~170–181 stretch covering admissions c.1620–1648 — verifies the no-John-Gurney negative at page level and recovers Henry Bond's trade (James Gurney's 1648 freedom master). (Available online — HathiTrust search-only, item uc1.b3259758; full text Not online: NRO proof copy JLD 3/4/40, printed copies widely held.)
11. **NRS 29 "G" block (printed p. ~197) and the Norwich city-records "E. 17" indenture for James Gurney.** The original indenture would name James's master and trade at binding — texture for the Francis B laceweaver household and the two-Francis separation. (Not online — NRO / Norfolk Record Society print.)
12. **Mary Barton/Burton tradition provenance.** Identify the earliest occurrence of the "colonial John m. Mary Barton/Burton 1636" claim carried in older compilations and the case-file v2 row. If the tradition predates modern indexing (19th-/early-20th-century American compilations), it is independent evidence pointing at Ackworth and would force the Ackworth probability up; if it first appears in IGI-era derivative trees, it is circular (compilers matching the same Ackworth index entry) and the row stays low. (Google Books pass Available online; Rigler 1994 in repo orbit; older American Gurney compilations Unknown online.)
13. **FamilySearch Full-Text Search campaign.** First pass run 2026-06-09 ("John Gurney," 1600s bucket, 134 results walked — see the 2026-06-09 working-notes entry for the harvest, including the Costessey 1634 rental, the c.1691-93 Suffolk administration entry, and the Quinapaug-equals-Providence reframing). Remaining passes: variant spellings (Gurny, Gurnay, Garny, Gurnoe, Gourney) in the 1600s bucket; "Francis Gurney" 1600s; Norfolk place-filtered sweeps; image pulls for every flagged hit. (Available online — familysearch.org/search/full-text.)
14. **Y-DNA scoping.** Check the FTDNA Gurney surname project (and similar) for Braintree-line male-line testers and any documented English Gurney male lines; a Y-line comparison is the only evidence class that could decisively confirm or refute deep paternal identity with the Norfolk line independent of record survival. Even "project exists; no Norfolk-documented testers" is a finding. (Available online — FTDNA project pages.)
15. **Robert Gvrney + Mary, Norwich 1622.** Pull the Findmypast England Marriages transcript for the parish field and check for indexed children of this couple — a previously unlogged Norwich Gurney household with a wife named Mary. (Available online — Findmypast.)
...
- [ ] Determine what became of **Edward and Agnes**, the confirmed East Dereham children of Francis. Live lead for Edward: an East Dereham copyhold Gurney family (Margery, Michael 1697–1758, Richard 1703+) persists in the manor court books from at least the 1680s — the 1623–1689 roll's succession recitals could connect their holding back to Edward or Francis (lead L-98).
...
- Father (if Candidate B): [`fact-sheets/g14-francis-gurney-fact-sheet.md`](https://github.com/allengurney/gurney-genealogy/blob/main/fact-sheets/g14-francis-gurney-fact-sheet.md)
- Current paired case file: [`research/case-files/john-gurney-case-file-v4.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/case-files/john-gurney-case-file-v4.md)
- Possible future case-file location: `research/case-files/candidate-b.md`
- Anderson audit trail: [`sources/validations/anderson-gmd-2015.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/validations/anderson-gmd-2015.md)
- Banks audit trail: [`sources/validations/banks-brownell-1937.md`](https://github.com/allengurney/gurney-genealogy/blob/main/sources/validations/banks-brownell-1937.md)
- Sources catalog entries: `data/sources.json` entries `anderson-gmd-2015`, `banks-brownell-1937`, `tag-10-70`, `nehgr-62-94`
- Related places (to be built): [`research/places/braintree-ma.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/places/braintree-ma.md), [`research/places/weymouth-ma.md`](https://github.com/allengurney/gurney-genealogy/blob/main/research/places/weymouth-ma.md), `research/places/bury-st-edmunds.md`, `research/places/east-dereham.md`
...
|---|---|---|---|
| 2026-06-09 | Case-file evaluation session | Norwich freemen/apprentices negative + James Gurney finding; G*rn* wildcard marriage sweep; case file v4.3 probability restructure (B ~65%, apprentice row removed); birth band synced to c.1607-12 | this session |
