...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "deathPlace": { "@type": "Place", "name": "Weymouth, Massachusetts" },
    "description": "Weymouth, Massachusetts proprietor and Freeman 1681; son of the colonial emigrant John Gurney G13 and Mary."
  }
}
</script>
...
<div class="facts-vitals-grid">
  <div class="fact-item">
    ...
    <div class="fact-value">c. 1630–1634, England. Came to Massachusetts as a young child with his father John Gurney (G13). <sup class="fn"><a href="#n1" id="ref-1">1</a></sup></div>
  </div>
  <div class="fact-item">
  ...
  <div class="fact-item">
    ...
    <div class="fact-value">Admitted Freeman of Massachusetts Bay, 1681. Held grants of land in Weymouth from before 1642–44. <sup class="fn"><a href="#n3" id="ref-3">3</a></sup></div>
  </div>
...
<ul>
  ...
  <li><strong>Admitted Freeman in 1681.</strong> Becoming a Freeman of Massachusetts Bay required formal church membership and entitled the holder to vote and hold public office. Richard's 1681 admission, after some four decades in Weymouth, marks his place in the community as a recognized adult member of the New England covenant. <sup class="fn"><a href="#n3" id="ref-3b">3</a></sup></li>
  <li><strong>Land at Braintree on the Abington–Bridgewater line passed to son Benjamin (G11).</strong> The land that anchored the family's Plymouth County identity in the early eighteenth century — and on which Granny Gurney's fire incident gave its name to a local swamp — was likely inherited by Benjamin from Richard, in turn likely inherited from John Gurney-1 (G13), the colonial emigrant. <sup class="fn"><a href="#n7" id="ref-7">7</a></sup></li>
</ul>
</section>
...
<div class="fact-panel">
  ...
  <div class="fact-buttons">
    <a href="/key-research/john-gurney-case-file.html">John Gurney case file (G13)</a>
...
<div class="fact-panel">
  ...
  <table class="fact-timeline-table">
    <tbody>
      ...
      <tr><td>c. 1630–34</td><td>Born in England.</td></tr>
      <tr><td>by 1642–44</td><td>Already a recorded landholder in Weymouth, Massachusetts.</td></tr>
      ...
      <tr><td>1681</td><td>Admitted Freeman of Massachusetts Bay.</td></tr>
      <tr><td>1683</td><td>Granted six acres on the west side of Great Pond by Weymouth town meeting "to build a house &amp; fence."</td></tr>
      <tr><td>1688</td><td>Wife Rebecca Taylor named in her father's will, proved.</td></tr>
      <tr><td>1691</td><td>Died October at Weymouth, intestate.</td></tr>
    </tbody>
  </table>
</div>
