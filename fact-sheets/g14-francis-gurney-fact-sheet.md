...
<ul>
  ...
  <li><strong>The leading candidate for the father of John Gurney-1 of Massachusetts.</strong> Francis's first marriage produces a family of exactly the right generation to have supplied the emigrant, in the right corner of England, in a household with the right trade and a documented reason to leave. No record names a John among his children, and the East Dereham register's returns for the years such a child would have been baptised do not survive — so the identification is the best available rather than a proven one. <sup class="fn"><a href="#n8" id="ref-8">8</a></sup></li>
...
<table class="facts-children">
  ...
  <tbody>
    <tr><td>John Gurney</td><td>—</td><td>Margaret Rybett</td><td>The G13 emigrant, if the identification holds. <strong>No record of his baptism survives</strong>, and the East Dereham register's returns for 1611–1616 — the years in which a first child of the 1611 marriage would fall — are lost, with no second copy anywhere. <sup class="fn"><a href="#n11" id="ref-11">11</a></sup></td></tr>
    <tr><td>Edward Gurney</td><td>27 May 1610</td><td>Margaret Rybett?</td><td>Baptized East Dereham. The firmest of the Norfolk baptisms — its year is fixed by a heading written into the parchment. The date falls sixteen months <em>before</em> the 1611 marriage, so his mother is not established. <sup class="fn"><a href="#n12" id="ref-12">12</a></sup></td></tr>
    <tr><td>Ann Gurney</td><td>c. 1612–16?</td><td>Margaret Rybett</td><td>An Ann Gurney married John Gilman at Hingham, Norfolk, on 1 October 1626. That marriage is a real record; what is unsupported is the link from this bride to Francis's household. <sup class="fn"><a href="#n13" id="ref-13">13</a></sup></td></tr>
    <tr><td>Agnes Gurney</td><td>buried 31 January 1616</td><td>Margaret Rybett</td><td>Known from her burial at East Dereham, which names her as Francis's daughter; no baptism survives. <sup class="fn"><a href="#n14" id="ref-14">14</a></sup></td></tr>
    <tr><td>Marye Gurney (first)</td><td>buried c. 1615–16</td><td>—</td><td>An East Dereham burial of a Marye in Francis's household. The relationship word in the entry does not read "daughter," and she is more likely a niece. <sup class="fn"><a href="#n15" id="ref-15">15</a></sup></td></tr>
...
His adult life helps explain how a cadet branch of an old Norfolk family could produce descendants who later crossed the Atlantic. Francis married first Margaret Rybett in 1611 — a daughter of the Rivet family of Garveston, in mid-Norfolk. The East Dereham baptisms then place the family back in Norfolk through the 1610s before the London baptisms at St Benet Fink begin in 1619. By the 1620s and 1630s, Francis appears to have been financially strained: a failed King's Lynn textile venture, continuing debts, and the 1634 sale of all his Norfolk and Suffolk lands suggest that the family's prospects had narrowed sharply.

That contraction is central to the argument about John Gurney-1 of Massachusetts, and it is the strongest part of it. A son trained in a trade, in a family that had just sold every acre it owned, had a textbook reason to try New England — and Francis's household sat in the corridor that sent most of the emigrants. Francis is on that reasoning the strongest presently identified candidate for John's father.

The identification stops short of proof, and the gap is specific. No surviving document names a John among Francis's children, and the East Dereham register's annual returns for 1611 to 1616 — the years in which a first child of the 1611 marriage would have been baptised — do not survive. The parish has no bound register for that period and no diocesan transcript before 1698, so those years cannot be recovered from any source. The question can never be settled from East Dereham, and it is not settled anywhere else.
</section>
...
<ol class="citation-list">
  ...
  <li id="n8">Norfolk Record Office, East Dereham, "Indented register bills, 1593-1641" (PD 86/41). The file is a set of loose annual certificates, and its returns for 25 March 1611 to 25 March 1616 do not survive. The Norfolk Record Office's own survey of the parish gives its registers as covering about 1549 to 1596, then nothing until 1679, with archdeacon's and bishop's transcripts only from 1698, so no second witness to those years has ever existed. The full weighing of the candidate parentage is in the <a href="/key-research/john-gurney-case-file.html">John Gurney case file</a> — a cross-reference, not a source. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-8">↩</a></li>
  <li id="n9">Daniel Gurney, vol. II; 1634 land-sale summary and failed King's Lynn textile venture references. <a class="citation-back" href="#ref-9">↩</a></li>
  ...
  <li id="n11">No baptism of a John to this household survives. A line in the East Dereham register (Norfolk Record Office, PD 86/41) indexed as "John the sonne of Nicholas Gorne" has been read as naming Francis; re-read across the full image run against recorded coordinates, the line adjudicated sits on a different membrane and belongs to an Enderby family, and the record the index describes is six years later and belongs to a Horne family. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-11">↩</a></li>
  <li id="n12">Norfolk Record Office, East Dereham register bills (PD 86/41), image 00721: Edward, son of ffrancis Gurney, baptised 27 May 1610. The year is fixed by the heading "East Dereham 1610" written into the parchment on the same membrane, which makes this the firmest-dated of the Norfolk entries. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-12">↩</a></li>
  <li id="n13">Hingham, Norfolk, parish register: marriage of Ann Gurney and John Gilman, worsted weaver, 1 October 1626. A search of Gurney-variant brides against Gilman-variant grooms in the Norfolk marriage index returns four results, none of them this pair and none before 1667, so nothing corroborates the link from this bride to Francis's household. Source IDs: <code>fs-england-marriages-1538-1973</code>; <code>findmypast-norfolk-banns-marriages-index</code>. <a class="citation-back" href="#ref-13">↩</a></li>
  <li id="n14">Norfolk Record Office, East Dereham register bills (PD 86/41): burial of "Agnes the daughter of ffrancis Gurny," 31 January 1616. FamilySearch's index transcribes the forename as "Susan," which the register does not support. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-14">↩</a></li>
  <li id="n15">Norfolk Record Office, East Dereham register bills (PD 86/41): burial of a Marye of Francis Gurney's household, late 1615 or January 1616. The relationship word is partly obscured by staining, and its opening letterform refutes "daughter" while being consistent with niece or nephew. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-15">↩</a></li>
  <li id="n16">Norfolk Record Office, East Dereham register bills (PD 86/41), image 00732: Marye, daughter of ffrancis Gurnoe, baptised 25 May 1618, inside the 1618-19 return. Source ID: <code>nro-pd-86-41</code>. <a class="citation-back" href="#ref-16">↩</a></li>
...
<div class="fact-panel">
  ...
  <table class="fact-timeline-table">
    <tbody>
      ...
      <tr><td>1610–1618</td><td>Children baptized at East Dereham, linking Francis to Norfolk through the 1610s.</td></tr>
