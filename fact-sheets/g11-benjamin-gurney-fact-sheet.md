...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "birthDate": "c. 1676",
    "deathDate": "1738",
    "birthPlace": { "@type": "Place", "name": "Weymouth, Massachusetts" },
    "description": "Massachusetts landholder; husband of Rebecca Staples; father of Benjamin Gurney G10."
  }
}
</script>
...
<div class="facts-vitals-grid">
  <div class="fact-item">
    ...
    <div class="fact-value">c. 1676, Weymouth, Massachusetts. Son of Richard Gurney (G12) and Rebecca Taylor. <sup class="fn"><a href="#n1" id="ref-1">1</a></sup></div>
  </div>
  <div class="fact-item">
    <div class="fact-label">Died</div>
    <div class="fact-value">Between 4 May 1738, when he made his will "very sick and weak in body," and 2 July 1739, when it was proved at Plymouth. <sup class="fn"><a href="#n2" id="ref-2">2</a></sup></div>
  </div>
  <div class="fact-item">
    <div class="fact-label">Occupation</div>
    <div class="fact-value">Farmer / landholder, Plymouth County, Massachusetts. Active across the Abington–Bridgewater line and Middleboro. <sup class="fn"><a href="#n3" id="ref-3">3</a></sup></div>
  </div>
...
<ul>
  ...
  <li><strong>A will that names his household.</strong> Dated 4 May 1738 and proved 2 July 1739, his will gave wife Rebeckah the use of the homestead, left son Benjamin the land bought of Joseph Richards, and set aside forty pounds for daughter Rebecca, wife of Daniel Taylor. Too weak to write, he signed with a mark; he named Rebeckah and Benjamin his executors, and it names only those two children — the documentary anchor for his death and his family. <sup class="fn"><a href="#n2" id="ref-2b">2</a></sup></li>
...
<ol class="citation-list">
  ...
  <li id="n2">Will of "Benj.a Gurney Sen.r" of Middleborough, dated 4 May 1738 and proved 2 July 1739, <a href="https://www.ancestry.com/search/collections/9069/records/716357">Plymouth County Probate, vol. 8, pp. 98–99</a>: to wife Rebeckah the use of the homestead and the moveable estate, to son Benjamin the parcel bought of Joseph Richards, and forty pounds to daughter Rebecca, wife of Daniel Taylor; signed by mark; wife and son Benjamin named executors; witnessed by James Whaley, Gershom Sa[m]son, and Nehemiah Bennett; proved before John Cushing, Judge of Probate. Image in "Massachusetts, U.S., Wills and Probate Records, 1635–1991" (Ancestry); Source ID: <code>ma-wills-probate-records</code>. Corroborated in Jean Gurney Rigler, <em>The Gurney Family from Aaron to Zuinglius</em>, Benjamin-3 entry (Source ID: <code>rigler-gurney-family-aaron-zuinglius-1994</code>). <a class="citation-back" href="#ref-2">↩</a></li>
...
<div class="fact-panel">
  ...
  <table class="fact-timeline-table">
    <tbody>
      ...
      <tr><td>c. 1676</td><td>Born, Weymouth, Massachusetts.</td></tr>
      ...
      <tr><td>c. 1730</td><td>Moved to Middleboro; sold the Williams farm to Abraham Pierce (Plymouth Registry 31:69, 70).</td></tr>
      <tr><td>1730</td><td>Bought Samuel Tinkham's Middleboro land jointly with son Benjamin (G10).</td></tr>
      <tr><td>1738–39</td><td>Made his will 4 May 1738; died; will proved at Plymouth 2 July 1739.</td></tr>
    </tbody>
  </table>
</div>
